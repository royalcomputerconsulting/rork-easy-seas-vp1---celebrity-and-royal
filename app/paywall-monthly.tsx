      ...
      <LinearGradient colors={['#0B1B33', '#123A63', '#E8F4FC']} locations={[0, 0.55, 1]} style={styles.bg}>
        <View style={styles.content} testID="paywall-monthly.scroll">
          ...
          <View style={styles.centerBlock}>
            ...
            <TouchableOpacity style={[styles.purchaseButton, (entitlement.isLoading || entitlement.isPro) && styles.purchaseButtonDisabled]} onPress={() => entitlement.subscribeProMonthly()} activeOpacity={0.85} disabled={entitlement.isLoading || entitlement.isPro} testID="paywall-monthly.subscribe-pro-monthly">
            ...
            <View style={styles.rowButtons}>
              <TouchableOpacity style={[styles.secondaryButton, entitlement.isLoading && styles.secondaryButtonDisabled]} onPress={() => entitlement.restore()} activeOpacity={0.9} disabled={entitlement.isLoading} testID="paywall-monthly.restore">
                <RefreshCcw size={18} color={COLORS.navyDeep}/>
                <Text style={styles.secondaryButtonText}>Restore Purchases</Text>
              </TouchableOpacity>

              <TouchableOpacity style={styles.secondaryButton} onPress={() => entitlement.openManageSubscription()} activeOpacity={0.9} testID="paywall-monthly.manage">
