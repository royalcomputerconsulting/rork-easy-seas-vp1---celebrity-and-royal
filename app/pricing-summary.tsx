...
export default function PricingSummaryScreen() {
    ...
    const renderSummaryView = () => (<ScrollView style={styles.scrollView} showsVerticalScrollIndicator={false}>
      ...
      <View style={styles.section}>
        ...
        {sortedCruises.map(({ cruise, status, history, drops }) => (<View key={cruise.id} style={styles.cruiseCard}>
    ...
    const renderPriceDropsView = () => (<ScrollView style={styles.scrollView} showsVerticalScrollIndicator={false}>
      <View style={styles.section}>
        <Text style={styles.sectionTitle}>Recent Price Drops</Text>
        {priceDrops.length === 0 ? (<View style={styles.emptyState}>
          ...
          </View>) : (priceDrops.map((drop, index) => (<View key={`${drop.cruiseKey}_${index}`} style={styles.dropCard}>
    ...
    const renderHistoryView = () => (<ScrollView style={styles.scrollView} showsVerticalScrollIndicator={false}>
      <View style={styles.section}>
        <Text style={styles.sectionTitle}>Price History</Text>
        <Text style={styles.sectionSubtitle}>
          {priceHistory.length} total price {priceHistory.length === 1 ? 'record' : 'records'} tracked
        </Text>
        {priceHistory.length === 0 ? (<View style={styles.emptyState}>
            ...
            .map((record) => (<View key={record.id} style={styles.historyCard}>
    ...
    return (<SafeAreaView style={styles.container} edges={['top']}>
      <View style={styles.header}>
        ...
        <TouchableOpacity style={styles.closeButton} onPress={() => router.back()} hitSlop={{ top: 10, bottom: 10, left: 10, right: 10 }}>
          <X color={COLORS.textPrimary} size={24}/>
        </TouchableOpacity>
      </View>

      <View style={styles.tabs}>
        <TouchableOpacity style={[styles.tab, selectedView === 'summary' && styles.tabActive]} onPress={() => setSelectedView('summary')}>
          <Text style={[styles.tabText, selectedView === 'summary' && styles.tabTextActive]}>
            Summary
          </Text>
        </TouchableOpacity>
        <TouchableOpacity style={[styles.tab, selectedView === 'drops' && styles.tabActive]} onPress={() => setSelectedView('drops')}>
          <Text style={[styles.tabText, selectedView === 'drops' && styles.tabTextActive]}>
            Price Drops
          </Text>
          
        </TouchableOpacity>
        <TouchableOpacity style={[styles.tab, selectedView === 'history' && styles.tabActive]} onPress={() => setSelectedView('history')}>
