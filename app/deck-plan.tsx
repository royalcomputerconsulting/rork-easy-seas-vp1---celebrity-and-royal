...
export default function DeckPlanPage() {
    ...
    const { getDeckPlanForShip, mappings, getMappingBySlot, getOccupancyRate, } = useDeckPlan();
    ...
    const totalMachinesOnShip = mappings.filter(m => m.shipName === shipName && m.isActive).length;
