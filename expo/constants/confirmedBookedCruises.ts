...
export const USER_CONFIRMED_BOOKED_CRUISE_MANIFEST: BookedCruise[] = [
  {
    ...
    notes: '2026 Club Royale points/cash-in/winnings reconciliation: 800 points earned, $4,000 cash-in (coin-in), known win/loss +$1,000.',
  },
  {
    ...
    winningsBroughtHome: 1000,
    calculationConfidence: 'actual',
    notes: '2026 Club Royale points/cash-in/winnings reconciliation: 3,000 points earned, $15,000 cash-in (coin-in), known win/loss +$1,000.',
  },
  {
    ...
    calculationConfidence: 'actual',
    notes: '2026 Club Royale points/cash-in/winnings reconciliation: 2,000 points earned, $10,000 cash-in (coin-in), known win/loss +$1,215.',
  },
  {
    ...
    calculationConfidence: 'actual',
    notes: '2026 Club Royale points/cash-in/winnings reconciliation: 860 points earned, $4,300 cash-in (coin-in), known win/loss +$3,500.',
  },
  {
    ...
    pointsEarned: 1102,
    coinIn: 5510,
    calculationConfidence: 'mixed',
    notes: '2026 Club Royale points/cash-in/winnings reconciliation: 1,102 points earned, $5,510 cash-in (coin-in). Win/loss not recorded for this sailing.',
  },
  {
    ...
    coinIn: 22905,
    calculationConfidence: 'mixed',
    notes: '2026 Club Royale points/cash-in/winnings reconciliation: 4,581 points earned, $22,905 cash-in (coin-in). Win/loss not recorded for this sailing.',
  },
  {
    ...
    calculationConfidence: 'actual',
    notes: '2026 Club Royale points/cash-in/winnings reconciliation: 1,000 points earned, $5,000 cash-in (coin-in), known win/loss +$700.',
  },
  {
    ...
    pointsEarned: 4000,
    coinIn: 20000,
    winningsBroughtHome: 1380,
    calculationConfidence: 'actual',
    notes: '2026 Club Royale points/cash-in/winnings reconciliation: 4,000 points earned, $20,000 cash-in (coin-in), known win/loss +$1,380.',
  },
  {
    ...
    pointsEarned: 2020,
    coinIn: 10100,
    winningsBroughtHome: 3800,
    calculationConfidence: 'actual',
    notes: '2026 Club Royale points/cash-in/winnings reconciliation: 2,020 points earned, $10,100 cash-in (coin-in), known win/loss +$3,800.',
  },
  {
    ...
    status: 'booked',
    completionState: 'upcoming',
    ports: ['Port Canaveral, Florida', 'Perfect Day at CocoCay, Bahamas', 'Charlotte Amalie, St. Thomas', 'Basseterre, St. Kitts & Nevis', 'Port Canaveral, Florida'],
    itinerary: [
      { day: 1, port: 'Port Canaveral, Florida', departure: '16:30', isSeaDay: false },
      { day: 2, port: 'Perfect Day at CocoCay, Bahamas', arrival: '07:00', departure: '17:00', isSeaDay: false },
      { day: 3, port: 'At Sea', isSeaDay: true },
      { day: 4, port: 'Charlotte Amalie, St. Thomas', arrival: '12:30', departure: '20:00', isSeaDay: false },
      { day: 5, port: 'Basseterre, St. Kitts & Nevis', arrival: '08:00', departure: '17:00', isSeaDay: false },
      { day: 6, port: 'At Sea', isSeaDay: true },
      { day: 7, port: 'At Sea', isSeaDay: true },
      { day: 8, port: 'Port Canaveral, Florida', arrival: '06:00', isSeaDay: false },
    ],
    seaDays: 3,
    portDays: 4,
    casinoOpenDays: 7,
