...
/**
 * Current Royal manifest confirmed by the user on 2026-08-26. This deliberately
 * keeps the second Harmony Sep 15 reservation as its own reservation row while
 * allowing calendar/weather summaries to collapse same-sailing cabins into one
 * physical sailing. Provider sync data can enrich these records but may not
 * replace their confirmed reservation/date/cabin facts with stale cards.
 */
export const USER_CONFIRMED_CURRENT_ROYAL_BOOKINGS: BookedCruise[] = [
  ...
  currentRoyalBooking({
    bookingId: '1861386', shipName: 'Utopia of the Seas', sailDate: '2026-10-19', returnDate: '2026-10-24', nights: 5,
    departurePort: 'Port Canaveral, Florida', destination: 'Perfect Day', itineraryName: '5 Night Perfect Day Cruise',
    cabinType: 'Ocean View', cabinNumber: '10526', deckNumber: '10', guestNames: DEFAULT_GUEST_NAMES,
    notes: 'User supplied this as a 4-night Perfect Day cruise, but the confirmed Oct 19–24 date range reconciles the current manifest to 86 nights.',
  }),
  currentRoyalBooking({
    bookingId: '891839', shipName: 'Icon of the Seas', sailDate: '2026-10-24', returnDate: '2026-10-31', nights: 7,
    departurePort: 'Miami, Florida', destination: 'Caribbean', itineraryName: '7 Night Cruise',
    cabinType: 'Ocean View', cabinNumber: '8672', deckNumber: '8', guestNames: [],
  }),
  currentRoyalBooking({
    bookingId: '5330038', shipName: 'Icon of the Seas', sailDate: '2026-10-31', returnDate: '2026-11-07', nights: 7,
    ...
    cabinType: 'Interior', cabinNumber: '3435', deckNumber: '3', guestNames: DEFAULT_GUEST_NAMES,
    ports: ['Miami, Florida', 'Costa Maya, Mexico', 'Roatan, Honduras', 'Cozumel, Mexico', 'Perfect Day at CocoCay, Bahamas', 'Miami, Florida'],
  }),
  currentRoyalBooking({
  ...
  currentRoyalBooking({
    bookingId: '6546856', shipName: 'Independence of the Seas', sailDate: '2027-01-03', returnDate: '2027-01-10', nights: 7,
    departurePort: 'Miami, Florida', destination: 'Western Caribbean', itineraryName: '7 Night Western Caribbean',
    cabinType: 'GTY', guestNames: DEFAULT_GUEST_NAMES,
  }),
  currentRoyalBooking({
    bookingId: '8153668', shipName: 'Independence of the Seas', sailDate: '2027-01-10', returnDate: '2027-01-17', nights: 7,
    departurePort: 'Miami, Florida', destination: 'Eastern Caribbean & Perfect Day', itineraryName: '7 Night Eastern Caribbean & Perfect Day',
    cabinType: 'GTY', guestNames: DEFAULT_GUEST_NAMES,
  }),
  currentRoyalBooking({
    bookingId: '3947846', shipName: 'Freedom of the Seas', sailDate: '2027-02-25', returnDate: '2027-03-06', nights: 9,
    departurePort: 'Fort Lauderdale, Florida', destination: 'Southern Caribbean', itineraryName: '9 Night Southern Caribbean',
    cabinType: 'Interior GTY', guestNames: DEFAULT_GUEST_NAMES,
  }),
];
