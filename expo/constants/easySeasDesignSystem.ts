...
export const EASY_SEAS_TOKENS = {
  color: {
    background: '#F7F3EC', surface: '#FFFCF7', surfaceAlt: '#DFF2EF', border: '#D9E1E6',
...
export const EASY_SEAS_THEME = {
  light: {
    background: '#F7F3EC', surface: '#FFFCF7', surfaceRaised: '#FFFFFF', surfaceMuted: '#DFF2EF',
    ...
    pageGradient: ['#EDF7F6', '#F7F3EC', '#F5F1E8'] as const,
  },
  dark: {
