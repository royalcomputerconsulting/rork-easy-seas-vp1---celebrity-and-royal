...
/**
 * User-visible identities for the seven fixed Easy Seas tabs. These are not
 * navigation changes: they give each existing destination a recognizable
 * purpose while preserving the logo, tab count, order, and every action.
 */
export const TAB_VISUAL_THEMES = {
  offers: {
    label: 'Offers and certificates',
    title: 'Offers',
    subtitle: 'Compare live offers, certificates, deadlines, and eligible sailings.',
    colors: ['#0F2247', '#1C2F7A', '#0E7FA7'] as const,
    accent: '#E6B63D',
    soft: '#FFF8E8',
  },
  cruises: {
    ...
    title: 'Cruises',
    subtitle: 'Search and filter available voyages without mixing in booked-trip work.',
    colors: ['#123D73', '#0E7FA7', '#3D87BF'] as const,
    accent: '#4EC0A5',
    soft: '#EAF7FA',
  },
  booked: {
    ...
    title: 'Booked',
    subtitle: 'Reservations, itineraries, readiness, value, and casino opportunity.',
    colors: ['#0F2247', '#123D73', '#16755F'] as const,
    accent: '#4EC0A5',
    soft: '#EBF7F3',
  },
  calendar: {
    ...
    colors: ['#0E7FA7', '#3D87BF', '#123D73'] as const,
    accent: '#E6B63D',
    soft: '#EDF7FB',
  },
  casino: {
    label: 'Club Royale and Blue Chip',
    title: 'Casino Command Center',
    subtitle: 'Points, value, trips, calculations, host intelligence, and strategy.',
    colors: ['#22201E', '#2C1D9A', '#D87924'] as const,
    accent: '#E6B63D',
    soft: '#F3EFFB',
  },
  slots: {
    ...
    colors: ['#0F2247', '#4A4A4A', '#8C3FC8'] as const,
    accent: '#D83A4A',
    soft: '#F6F1FA',
  },
  settings: {
    ...
    colors: ['#123D73', '#58585B', '#0E7FA7'] as const,
    accent: '#3D87BF',
    soft: '#EEF4F7',
  },
} as const;
...
export const EASY_SEAS_TYPE_STYLES = {
  ...
  body: { fontFamily: 'System', fontSize: 15, lineHeight: 21, fontWeight: '400' },
  ...
  evidence: { fontFamily: 'System', fontSize: 12, lineHeight: 18, fontWeight: '400' },
} as const;
