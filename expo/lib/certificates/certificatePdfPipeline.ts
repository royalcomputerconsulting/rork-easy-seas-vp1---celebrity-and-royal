...
function parseCertificateText(
  ...
  return {
    ...
    rejectedRows,
    pageReports,
    provenance: { ...options.provenance, parserSource: options.parserSource, parserVersion: options.parserVersion, parseStatus: status, warnings: warnings.length > 0 ? warnings : undefined },
    warnings,
  };
}
