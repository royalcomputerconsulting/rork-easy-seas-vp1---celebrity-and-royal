...
const CONFIRMED_PINNACLE_CRUISE_PLAN: BookedCruise[] = [
  ...
  },
  {
    ...
    compValue: 5445.08,
    cruiseValueCaptured: 5445.08,
    totalEconomicValue: 5445.08,
    offerCode: '26TIER3',
    ...
    notes: 'Reservation issued 2026-04-28. Cruise-only package. Casino Comp CGRP-FIT PROMO YHP5-Casino Slots. Cruise fare retail value $5,596; taxes/fees/port expenses $150.92; amount paid $200; balance due $0; onboard credit $50. Casino analytics should use $5,596 retail value and $150.92 net effective paid while preserving the $200 paid amount separately.',
  },
  {
    id: 'booked-4097701',
