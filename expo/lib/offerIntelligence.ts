...
export function calculateCasinoPaysForOffer(offer: CasinoOffer, cruises: Cruise[] = []): CasinoPaysForResult {
  ...
  console.log('[OfferIntelligence] Casino Pays For calculated:', { offerCode: offer.offerCode, retailCabinValue, taxesFees, upgradeCost, freePlay, onboardCredit, casinoCoveredValue, userOutOfPocket, effectiveSavingsPercentage, missingInputs });
