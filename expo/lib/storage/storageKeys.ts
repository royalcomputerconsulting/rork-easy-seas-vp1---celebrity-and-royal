...
export const ALL_STORAGE_KEYS = {
  ...
  CASINO_HOST_CRM: '@easyseas/casinoHostCrm',
  B2B_TRIP_PLANS: '@easyseas/b2bTripPlans',
  OFFLINE_VOYAGE_PACKS: '@easyseas/offlineVoyagePacks',
  TRAVEL_READINESS_VAULT: '@easyseas/travelReadinessVault',
  PRICE_MONITOR_PREFERENCES: '@easyseas/priceMonitorPreferences',
  LIFECYCLE_HOME_PREFERENCES: '@easyseas/lifecycleHomePreferences',
  INTELLIGENCE_FILTERS: '@easyseas/intelligenceFilters',
  TRIP_COST_ENTRIES: '@easyseas/tripCostEntries',
  OFFER_LINEAGE_EVENTS: '@easyseas/offerLineageEvents',
  RECOMMENDATION_ACTIONS: '@easyseas/recommendationActions',
  RESPONSIBLE_PLAY_LIMITS: '@easyseas/responsiblePlayLimits',
  SHIP_CASINO_REPORTS: '@easyseas/shipCasinoReports',
  CABIN_EVALUATIONS: '@easyseas/cabinEvaluations',
  PORT_DAY_PREFERENCES: '@easyseas/portDayPreferences',
  TRAVEL_CHECKLISTS: '@easyseas/travelChecklists',
  CARNIVAL_SYNC_CHECKPOINT: 'easyseas_carnival_sync_checkpoint',
  ASK_ALL_OFFERS_CONVERSATIONS: 'easyseas_ask_all_offers_conversations_v1',
  OPERATING_CENTER_PREFERENCES: '@easyseas/operatingCenterPreferences/v1',
  SAVED_WATCHLISTS: '@easyseas/savedWatchlists/v1',
  FARE_DECISION_EVENTS: '@easyseas/fareDecisionEvents/v1',
  CABIN_INTELLIGENCE: '@easyseas/cabinIntelligence/v1',
  PORT_DAY_PLANS: '@easyseas/portDayPlans/v1',
  DISRUPTION_HISTORY: '@easyseas/disruptionHistory/v1',
  CRUISE_JOURNALS: '@easyseas/cruiseJournals/v1',
  TRAVEL_PARTIES: '@easyseas/travelParties/v1',
} as const;
