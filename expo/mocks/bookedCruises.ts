...
export const BOOKED_CRUISES_DATA: BookedCruise[] = [
  {
    ...
    nights: 6,
    cabinType: 'Interior (Virtual Balcony)',
    cabinNumber: '9539',
  ...
  },
  {
    ...
    departurePort: 'Los Angeles, California',
    destination: 'Mexican Riviera',
    itineraryName: '6 Night Cabo & Ensenada',
    nights: 6,
  ...
  },
  {
    ...
    itineraryName: '7 Night W. Caribbean & Perfect Day',
    nights: 7,
  ...
  {
    id: 'booked-allure-apr29',
    reservationNumber: 'A05-2512A07',
    shipName: 'Allure of the Seas',
    sailDate: '2026-04-29',
    returnDate: '2026-05-02',
    departurePort: 'Fort Lauderdale, Florida',
    destination: 'Bahamas',
    itineraryName: '3 Night Bahamas & Perfect Day',
    nights: 3,
    cabinType: 'Suite GTY',
    guestNames: ['Scott Merlis'],
    guests: 1,
    status: 'booked',
    completionState: 'upcoming',
    ports: ['Fort Lauderdale, Florida', 'Perfect Day at CocoCay', 'Nassau, Bahamas'],
    taxes: 241.04,
