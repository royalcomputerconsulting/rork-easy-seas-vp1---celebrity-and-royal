...
assert(app.expo.android.versionCode === 120410, 'Android version code must be 120410');
...
assert(batch.includes('Retrying ${code} individually.'), 'Individual retry activity must be logged');
