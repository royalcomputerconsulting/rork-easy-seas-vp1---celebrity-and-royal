...
assert(appJson.expo.version === '12.3.0', 'app.json expo.version must be 12.3.0');
assert(appJson.expo.ios.buildNumber === '12.3.0', 'iOS buildNumber must be 12.3.0');
assert(appJson.expo.android.versionCode === 120300, 'Android versionCode must be 120300');
assert(pkg.version === '12.3.0', 'package.json version must be 12.3.0');
