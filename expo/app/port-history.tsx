...
const styles = StyleSheet.create({
  ...
  summaryCell: { flex: 1, backgroundColor: '#F5F5F4', borderRadius: BORDER_RADIUS.md, padding: SPACING.sm, borderWidth: 1, borderColor: '#D5D5D0', alignItems: 'center' },
  ...
  portRow: { flexDirection: 'row', alignItems: 'center', borderRadius: BORDER_RADIUS.md, borderWidth: 1, borderColor: '#D5D5D0', padding: SPACING.sm, marginBottom: SPACING.xs, backgroundColor: '#F5F5F4' },
  ...
  repeatItineraryRow: { backgroundColor: '#F5F5F4', borderRadius: BORDER_RADIUS.md, padding: SPACING.sm, marginBottom: SPACING.xs, borderWidth: 1, borderColor: '#D5D5D0' },
