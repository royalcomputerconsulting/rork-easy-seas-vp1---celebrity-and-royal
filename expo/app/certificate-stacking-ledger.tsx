...
import { Alert, InteractionManager, Linking, Modal, ScrollView, StyleSheet, Text, TextInput, TouchableOpacity, View } from 'react-native';
    ...
    <SafeAreaView style={styles.container} edges={['top']}>
      <LinearGradient colors={['#10223A', '#183C63', '#0E7FA7']} style={styles.header}>
        <View style={styles.headerTop}>
          <TouchableOpacity style={styles.circleButton} onPress={() => router.back()} testID="stacking-ledger.back"><ChevronLeft size={20} color="#FFFFFF" /></TouchableOpacity>
          <View style={styles.circleButton}><Link2 size={17} color="#FFFFFF" /></View>
        </View>
...
const styles = StyleSheet.create({
  ...
  circleButton: { width: 40, height: 40, borderRadius: 20, backgroundColor: 'rgba(255,255,255,0.14)', alignItems: 'center', justifyContent: 'center' },
  eyebrow: { color: '#9FE7F5', fontSize: 11, fontWeight: '900', letterSpacing: 1.2, textTransform: 'uppercase' },
  title: { color: '#FFFFFF', fontSize: 29, fontWeight: '900', marginTop: 4 },
  subtitle: { color: 'rgba(255,255,255,0.8)', fontSize: 13, lineHeight: 20, marginTop: SPACING.sm },
  ...
  badge: { backgroundColor: '#E2E8F0', borderRadius: 999, paddingHorizontal: 9, paddingVertical: 5 },
