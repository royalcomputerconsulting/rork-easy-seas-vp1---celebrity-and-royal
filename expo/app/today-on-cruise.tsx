        ...
        <ResponsiveContainer>
          <View style={styles.hero}>
            <Image
              source={{
                uri:
                  getUniqueImageForCruise(
                    brief.cruise.id,
                    brief.cruise.destination || brief.cruise.itineraryName || '',
                    brief.cruise.sailDate,
                    brief.cruise.shipName
                  ) || DEFAULT_CRUISE_IMAGE,
              }}
              resizeMode="cover"
              style={StyleSheet.absoluteFillObject}
              accessibilityLabel={`${brief.cruise.shipName} voyage artwork`}
            />
            <LinearGradient colors={['rgba(7,24,45,.18)', 'rgba(11,63,103,.76)', 'rgba(4,48,66,.94)']} style={styles.heroOverlay}>
          ...
          <View style={styles.sectionCard} testID="today-on-cruise-location-card">
            <ThemedSectionHeader
              tab="booked"
              emoji="📍"
              title={brief.locationLabel}
              subtitle={formatVoyageDate(brief.dateKey)}
              tone="weather"
              compact
              testID="today-on-cruise-location-heading"
            />
          ...
          <View style={styles.sectionCard} testID="today-on-cruise-agenda-card">
            <ThemedSectionHeader
              ...
              subtitle="Dining, excursions, and saved plans for this voyage day."
              tone="info"
              compact
              ...
              testID="today-on-cruise-agenda-heading"
            />
          ...
          <View style={styles.sectionCard} testID="today-on-cruise-essentials-card">
            <ThemedSectionHeader
              tab="booked"
              emoji="🎟️"
              title="Voyage essentials"
              subtitle="Reservation, guests, and stateroom details saved for this sailing."
              tone="success"
              compact
              testID="today-on-cruise-essentials-heading"
            />
...
const styles = StyleSheet.create({
  safeArea: { flex: 1, backgroundColor: '#F3F3F2' },
  scrollContent: { paddingBottom: 42 },
  hero: { margin: SPACING.md, marginBottom: SPACING.sm, minHeight: 248, borderRadius: 22, overflow: 'hidden', backgroundColor: '#0F2247', ...SHADOW.lg },
  heroOverlay: { flex: 1, minHeight: 248, justifyContent: 'flex-end', padding: SPACING.lg },
  ...
  shipName: { marginTop: SPACING.lg, color: COLORS.white, fontFamily: TYPOGRAPHY.fontFamilyEditorialSemibold, fontSize: 30, fontWeight: '600' },
  ...
  sectionCard: { marginHorizontal: SPACING.md, marginTop: SPACING.sm, padding: SPACING.md, borderRadius: 18, backgroundColor: '#FFFDF9', borderWidth: 1, borderColor: '#D6E3EA', ...SHADOW.sm },
  ...
  noAgenda: { marginTop: SPACING.md, flexDirection: 'row', alignItems: 'center', gap: SPACING.sm, padding: SPACING.md, borderRadius: BORDER_RADIUS.md, backgroundColor: '#F5F5F4' },
  noAgendaText: { flex: 1, color: '#64748B', fontSize: TYPOGRAPHY.fontSizeSM, lineHeight: 19 },
  agendaRow: { flexDirection: 'row', alignItems: 'center', marginTop: SPACING.sm, paddingTop: SPACING.sm, borderTopWidth: 1, borderTopColor: '#D5D5D0' },
  agendaIcon: { width: 34, height: 34, borderRadius: 17, alignItems: 'center', justifyContent: 'center', backgroundColor: '#F5F5F4' },
