      ...
      <ScrollView contentContainerStyle={styles.content}>
        ...
        <View style={styles.rowButtons}>
          ...
          <TouchableOpacity style={styles.primaryButton} onPress={() => router.push('/ask-my-data' as any)}>
            <Text style={styles.primaryButtonText}>Agent SEA</Text>
          </TouchableOpacity>
        </View>
      </ScrollView>
    </SafeAreaView>
...
const styles = StyleSheet.create({
  ...
  stackCard: { borderWidth: 1, borderColor: '#D5D5D0', borderRadius: BORDER_RADIUS.md, padding: SPACING.sm, marginBottom: SPACING.sm, backgroundColor: '#F5F5F4' },
