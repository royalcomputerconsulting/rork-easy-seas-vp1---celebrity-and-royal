...
export default function LoyaltyDataScreen() {
  ...
  const openCrownAnchorDrill = useCallback(() => {
    drill.open({
      ...
      summary: 'Crown & Anchor cruise points are earned per completed night — 1 point per night for each occupant in shared accommodations or 2 points per night for a solo traveler, plus 1 additional point per night in a suite. Levels are lifetime totals; they never reset.',
      formula: 'Crown & Anchor Points = Nights × (1 shared or 2 solo) + Nights × 1 when the saved cabin category is a suite',
      inputs: [
  ...
  }, [drill, crownAnchorLevel, nextLevelKey, pinnacleStepperLabels]);
