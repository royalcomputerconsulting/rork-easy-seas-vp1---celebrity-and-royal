...
const SECTIONS: { heading: string; entries: FormulaEntry[] }[] = [
  ...
  },
  {
    heading: 'Play Hours',
    entries: [
      { title: 'Estimated Casino Play Hours', formula: 'Final cruise points \u00f7 points-per-hour assumption, capped by casino-available itinerary hours', notes: 'Cruise-level points and win/loss are the normal source. Actual timed sessions remain optional evidence only when a user enters them.' },
      ...
      { title: 'Average Daily Theo', formula: 'Theoretical loss \u00f7 explicit rated gaming days, or itinerary-derived casino-available days', notes: 'If the casino does not provide rated days, Easy Seas estimates the denominator from saved itinerary/open-day data.' },
    ],
  },
  {
