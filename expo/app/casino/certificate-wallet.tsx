...
export default function CertificateWalletScreen() {
  ...
  const body = (
    <ScrollView style={{ flex: 1 }} contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
      ...
      <TouchableOpacity style={styles.linkReviewButton} onPress={() => router.push('/casino/certificate-link-review')} testID="certificate-link-review-button">
        <Link2 size={18} color="#fff" /><Text style={styles.linkReviewText}>Review certificate-to-cruise links</Text>
      </TouchableOpacity>
...
const styles = StyleSheet.create({
  ...
  linkReviewButton: { backgroundColor: COLORS.royalBlue, borderRadius: 12, paddingVertical: 12, paddingHorizontal: 14, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 8 },
  linkReviewText: { color: '#fff', fontSize: 13, fontWeight: '800' as const },
});
