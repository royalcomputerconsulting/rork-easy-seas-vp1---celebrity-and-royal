...
// Compatibility names keep this evidence-heavy screen functional while its
// surfaces follow the shared premium Easy Seas light anatomy.
const COLORS = { navy: '#F3F3F2', panel: '#FFFFFF', card: '#FFFFFF', gold: '#0E7FA7', white: '#333334', muted: '#676A70', line: '#D5D5D0', green: '#16755F', amber: '#D87924', red: '#A52B34' };
