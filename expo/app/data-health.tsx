...
const styles = StyleSheet.create({
  ...
  warningCard: { backgroundColor: '#FEF3C7', borderWidth: 1, borderColor: '#E6B63D' },
  goodCard: { backgroundColor: '#ECFDF5', borderWidth: 1, borderColor: '#4EC0A5' },
  statusCopy: { flex: 1 },
  ...
  metricCard: { width: '48%', backgroundColor: '#FFFFFF', borderRadius: BORDER_RADIUS.lg, padding: SPACING.md, borderWidth: 1, borderColor: '#D5D5D0' },
  ...
  sectionCard: { backgroundColor: '#FFFFFF', borderRadius: BORDER_RADIUS.lg, padding: SPACING.md, marginBottom: SPACING.md, borderWidth: 1, borderColor: '#D5D5D0' },
