...
function CarnivalSyncScreen() {
    ...
    const { state, webViewRef, cruiseLine: _cruiseLine, setCruiseLine: _setCruiseLine, config: _config, openLogin, runIngestion, syncToApp, cancelSync, handleWebViewMessage, addLog, extendedLoyaltyData, webViewUrl, onPageLoaded, } = useRoyalCaribbeanSync();
        ...
        <ScrollView style={styles.scrollView} contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={true}>
          ...
          <View style={styles.actionsContainer}>
            {Platform.OS === 'web' ? (<View style={styles.webCredentialsContainer}>
                ...
                <View style={styles.webSyncOptionsContainer}>
                  <View style={[styles.webSyncOptionCard, isCompactWindow && styles.webSyncOptionCardCompact]}>
                    ...
                    <View style={styles.webSyncOptionContent}>
                      ...
                      <Pressable style={[styles.webSyncButton, { marginTop: 12, backgroundColor: CARNIVAL_RED }, isDownloadingExtension && styles.buttonDisabled]} onPress={() => { void handleDownloadExtension(); }} disabled={isDownloadingExtension} testID="carnival-download-extension-card-button">
                        {isDownloadingExtension ? (<ActivityIndicator size="small" color="#fff"/>) : (<Download size={18} color="#fff"/>)}
                  ...
                  <View style={[styles.webSyncOptionCard, isCompactWindow && styles.webSyncOptionCardCompact]}>
                    ...
                    <View style={styles.webSyncOptionContent}>
                      ...
                      <Pressable style={[styles.webSyncButton, { marginTop: 12, backgroundColor: '#0f766e' }]} onPress={() => Linking.openURL('https://www.carnival.com/')} testID="carnival-open-website-card-button">
                  ...
                  <View style={[styles.webSyncOptionCard, isCompactWindow && styles.webSyncOptionCardCompact]}>
                    ...
                    <View style={styles.webSyncOptionContent}>
                      ...
                      <Pressable style={[styles.webSyncButton, { marginTop: 12, backgroundColor: '#0f766e' }]} onPress={handleOpenImportTools} testID="carnival-import-tools-card-button">
                  ...
                  <View style={[styles.webSyncOptionCard, isCompactWindow && styles.webSyncOptionCardCompact]}>
                    ...
                    <View style={styles.webSyncOptionContent}>
                      ...
                      <Pressable style={[styles.webSyncButton, { marginTop: 12, backgroundColor: '#8b5cf6' }]} onPress={() => setShowCookieModal(true)} testID="carnival-cookie-sync-button">
              ...
              </View>) : (<View style={styles.mobileActionsContainer}>
                ...
                <View style={styles.quickActionsGrid}>
                  ...
                  <Pressable style={[styles.quickActionButton, (!canRunIngestion || isRunning) && styles.buttonDisabled]} onPress={handleRunIngestion} disabled={!canRunIngestion || isRunning} testID="carnival-run-ingestion-button">
                    <RefreshCcw size={20} color="#34d399"/>
                    <Text style={styles.quickActionLabel}>SYNC NOW</Text>
                  </Pressable>

                  <Pressable style={styles.quickActionButton} onPress={() => {
          ...
          <Modal visible={showConfirmation} transparent={true} animationType="fade" onRequestClose={cancelSync}>
            <View style={styles.modalOverlay}>
              <View style={styles.confirmationModal}>
                ...
                <ScrollView style={styles.confirmationScroll} contentContainerStyle={styles.confirmationContent} showsVerticalScrollIndicator={false}>
                ...
                <View style={styles.confirmationButtons}>
                  ...
                  <Pressable style={[styles.button, styles.confirmButton, isConfirmingSync && styles.buttonDisabled]} onPress={handleConfirmSync} disabled={isConfirmingSync} testID="carnival-confirm-sync-button">
          ...
          <WebSyncCredentialsModal visible={showCredentialsModal} onClose={() => { setShowCredentialsModal(false); setWebSyncError(null); }} onSubmit={handleWebSync} cruiseLine="carnival" isLoading={webLoginMutation.isPending} error={webSyncError}/>

          <WebCookieSyncModal visible={showCookieModal} onClose={() => { setShowCookieModal(false); setCookieSyncError(null); }} onSubmit={handleCookieSync} cruiseLine="carnival" isLoading={cookieSyncMutation.isPending} error={cookieSyncError}/>
        </ScrollView>
      </View>
    </>);
}
