...
import { Ship, Clock, ChevronRight, CheckCircle, X, Dice5, Star, DollarSign, Ban, Archive, BedDouble, Users, } from 'lucide-react-native';
...
export default function OfferDetailsScreen() {
    ...
    return (<View style={styles.container}>
      ...
      <SafeAreaView style={styles.safeArea} edges={['top']}>
        ...
        <FlatList data={offerData.cruises} renderItem={renderCruiseCard} keyExtractor={(item) => item.id} extraData={sortBy} contentContainerStyle={styles.listContent} showsVerticalScrollIndicator={false} ListEmptyComponent={<View style={styles.emptyState}>
