              ...
              >
                ...
                <View style={styles.entitlementTruthGrid} testID="offer-details-entitlement-truth">
                  <View style={styles.entitlementTruthItem}>
                    ...
                    <Text style={styles.entitlementTruthSource}>{offerEntitlementTruth.points.source}</Text>
                  </View>
                  <View style={styles.entitlementTruthItem}>
                    ...
                    <Text style={styles.entitlementTruthSource}>{offerEntitlementTruth.cabin.source}</Text>
                  </View>
                  <View style={styles.entitlementTruthItem}>
                    ...
                    <Text style={styles.entitlementTruthSource}>{offerEntitlementTruth.guests.source}</Text>
                  </View>
                  <View style={styles.entitlementTruthItem}>
                    ...
                    <Text style={styles.entitlementTruthSource}>
                      {offerInfo.normalizedValue.components.cabinRetail.sourceField || 'No provider or sailing price'}
                    </Text>
                  </View>
                </View>
