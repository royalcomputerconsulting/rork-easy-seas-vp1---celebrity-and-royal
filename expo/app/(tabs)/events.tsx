      ...
      >
        ...
        {tarotMonthMode && tarotCard ? (
          <View style={styles.tarotDayContent}>
            <Sparkles size={10} color={tarotCard.luckModifier < 0 ? '#991B1B' : '#6D28D9'} />
            <Text
  ...
  return (
    <View style={[styles.container, { backgroundColor: experienceColors.background }]}> 
      ...
      <SafeAreaView style={styles.safeArea} edges={['top']}>
        ...
        >
          <ResponsiveContainer>
            <TabIdentityBand tab="calendar" compact detail={viewMode === 'month' ? 'Monthly planning view' : viewMode === 'events' ? 'Agenda and event view' : `${viewMode} planning view`} />

          {!tarotMonthMode ? <IntelligenceFilterStrip contextLabel="Calendar" variant="bookedCruises" compact /> : null}
            ...
            {(['events', 'week', 'month', '90days', 'passenger'] as ViewMode[]).map((mode) => (
              ...
              >
                <Text style={[
                  ...
                  {mode === 'events' ? 'Agenda' : mode === 'week' ? 'Week' : mode === 'month' ? 'Month' : mode === '90days' ? '90 Days' : 'Passenger'}
                </Text>
              </TouchableOpacity>
            ))}
          </View>
          ...
          {(viewMode === 'month' || viewMode === 'week') && (
            <View style={styles.monthNavigation}>
              ...
              >
                <Sparkles size={17} color={tarotMonthMode ? COLORS.white : '#6D28D9'} />
              </TouchableOpacity>
