    ...
    return (
      <>
        <TabIdentityBand
          tab="casino"
          artworkTab="slots"
          label="Casino · task 5 of 5"
          title="Slots & Machine Guide"
          subtitle="Search machines, record play, save favorites, and review onboard observations."
          compact
          detail={`${filteredMachines.length.toLocaleString()} machine${filteredMachines.length === 1 ? '' : 's'} in this view`}
          testID="casino-slots-identity"
        />
        <View style={styles.header}>
          <Text style={styles.subtitle}>
            Your machine actions are kept together below so search, maps, observations, and play records stay within Casino.
          </Text>
        ...
        <CollapsibleSection
          ...
          emoji="🧠"
        >
          <MachineStrategyCard showHeader={false} />
        </CollapsibleSection>
        ...
        <CollapsibleSection
          ...
          emoji="🗺️"
        >
          <ShipMachinesExplorer showHeader={false} />
        </CollapsibleSection>
        ...
        <View style={styles.hoursCardsSection}>
          <ThemedSectionHeader tab="casino" emoji="⏰" title="Playing plan" subtitle="Preferred hours, casino availability, and today’s opportunities." tone="success" compact />
          <View style={styles.sectionBody}>
          <PlayingHoursCard
