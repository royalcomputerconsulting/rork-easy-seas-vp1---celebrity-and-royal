...
export default function TabLayout() {
      ...
      : routeSource === 'cruises' || routeSource === 'available'
        ...
        : routeSource === 'calendar'
          ...
          : routeSource === 'casino'
            ...
            : 'overview'
    : null;
  const inactiveTint = isDark ? colors.muted : EASY_SEAS_UX.color.brandNavy;
  const activeTint = isDark ? colors.accent : '#0E7FA7';
  ...
  const tabLabel = useCallback((tab: string, label: string) => ({ focused }: { focused: boolean; color: string; position?: string; children?: string }) => {
    ...
    return <Text style={[styles.tabLabel, { color: active ? activeTint : inactiveTint }]}>{label}</Text>;
  ...
  return (
    <Tabs
      ...
      screenOptions={{
        ...
        tabBarActiveTintColor: isDark ? colors.accent : '#0E7FA7',
        tabBarInactiveTintColor: isDark ? colors.muted : EASY_SEAS_UX.color.brandNavy,
        ...
        tabBarLabelStyle: {
          ...
          lineHeight: width < 430 ? 11 : 14,
          fontWeight: '600' as const,
          marginTop: 1,
          letterSpacing: width < 430 ? -0.35 : 0,
        },
        tabBarItemStyle: {
          paddingHorizontal: 0,
          minWidth: 0,
    ...
    >
      <Tabs.Screen
        ...
        options={{
          title: "Offers",
          tabBarLabel: tabLabel('overview', 'Offers'),
          tabBarButtonTestID: "tab-offers",
          tabBarIcon: ({ focused }) => {
            const active = visualFocus('overview', focused);
            return (
            <View style={[styles.iconContainer, { minWidth: minimumControlSize }, active && [styles.activeIconContainer, { borderTopColor: isDark ? colors.accent : '#167C80', backgroundColor: isDark ? colors.surfaceMuted : EASY_SEAS_UX.color.seafoam }]]}>
              <Tag color={active ? activeTint : inactiveTint} size={22} strokeWidth={active ? 2.5 : 2} />
            </View>
          )},
        }}
      />
      <Tabs.Screen
        ...
        options={{
          title: "Cruises",
          tabBarLabel: tabLabel('scheduling', 'Cruises'),
      ...
      <Tabs.Screen
        ...
        options={{
          title: "Booked",
          tabBarLabel: tabLabel('booked', 'Booked'),
      ...
      <Tabs.Screen
        ...
        options={{
          ...
          tabBarIcon: ({ color, focused }) => (
            <View style={[styles.iconContainer, { minWidth: minimumControlSize }, focused && [styles.activeIconContainer, { borderTopColor: isDark ? colors.accent : '#167C80', backgroundColor: isDark ? colors.surfaceMuted : EASY_SEAS_UX.color.seafoam }]]}>
      ...
      <Tabs.Screen
        ...
        options={{
          title: "Add",
          tabBarLabel: tabLabel('quick-actions', 'Add'),
