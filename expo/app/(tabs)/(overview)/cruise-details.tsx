...
const CompactFact = memo(function CompactFact({ icon: Icon, value, label }: CompactFactProps) {
    return (<View style={styles.compactFact}>
...
export default function CruiseDetailsScreen() {
    ...
    const cruise = useMemo(() => {
        ...
        if (found && found.offerCode) {
            ...
            const linkedOff = allOffers.find(o => o.offerCode === found!.offerCode ||
    ...
    useEffect(() => {
        if (cruise) {
            const imageUrl = getUniqueImageForCruise(cruise.id, cruise.destination || cruise.itineraryName || '', cruise.sailDate, cruise.shipName);
    ...
    const linkedOffer = useMemo((): CasinoOffer | undefined => {
        ...
        const allOffers = [...(storeOffers || []), ...(localData.offers || [])];
        return allOffers.find(o => o.offerCode === cruise.offerCode ||
    ...
    const itineraryDisplay = useMemo((): {
        days: {
            day: number;
            port: string;
            isSeaDay: boolean;
        ...
        if (!cruise)
            return { days: [], needsManualEntry: true, source: 'none' };
        ...
        const parsePortsAndTimes = (portsAndTimes: string): {
            day: number;
            port: string;
            isSeaDay: boolean;
        }[] => {
        ...
        // Search all offers in both localData and storeOffers
            ...
            const offerByCode = cruise.offerCode ? allOffers.find(o => o.offerCode === cruise.offerCode && (o.portsAndTimes || (o.ports && o.ports.length > 0))) : null;
    ...
    if (!cruise || !cruiseDetails) {
        ...
        <LinearGradient colors={[COLORS.navyDeep, COLORS.navyMedium]} style={StyleSheet.absoluteFill}/>
    ...
    return (<View style={styles.container}>
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.scrollContent}>
        <View style={styles.heroPlaceholder}>
          <Image source={{ uri: heroImageUri }} style={StyleSheet.absoluteFill} resizeMode="cover" onError={() => setHeroImageUri(DEFAULT_CRUISE_IMAGE)}/>
          <LinearGradient colors={['rgba(0,31,63,0.3)', 'rgba(0,31,63,0.7)']} style={StyleSheet.absoluteFill}/>
          
          <View style={styles.heroButtonsContainer}>
            <TouchableOpacity style={styles.editAllButton} onPress={openFullEditModal} activeOpacity={0.7}>
              <Edit3 size={18} color={COLORS.beigeWarm}/>
              <Text style={styles.editAllButtonText}>Edit</Text>
            </TouchableOpacity>
            
            {!isBooked ? (<TouchableOpacity style={styles.bookHeaderButton} activeOpacity={0.8} onPress={handleBookCruise} testID="book-cruise-button">
                <Text style={styles.bookHeaderButtonText}>Book</Text>
              </TouchableOpacity>) : (<TouchableOpacity style={styles.unbookHeaderButton} activeOpacity={0.8} onPress={() => setUnbookModalVisible(true)} testID="unbook-cruise-button">
        ...
        <View style={styles.content}>
          <View style={styles.headerSection}>
            ...
            {!!(linkedOffer?.offerName || linkedOffer?.title || cruise.offerCode) && (<View style={styles.offerNameContainer}>
          ...
          <View style={styles.modalContent}>
            ...
            <View style={styles.modalBody}>
              <View style={styles.inputGroup}>
                ...
                <TextInput style={styles.input} value={editWinnings} onChangeText={setEditWinnings} keyboardType="numeric" placeholder="Enter winnings or losses" placeholderTextColor={COLORS.textSecondary}/>
              </View>

              <View style={styles.inputGroup}>
                <Text style={styles.inputLabel}>Points Earned</Text>
                <TextInput style={styles.input} value={editPoints} onChangeText={setEditPoints} keyboardType="numeric" placeholder="Enter points earned" placeholderTextColor={COLORS.textSecondary}/>
              </View>
            </View>
      ...
      <Modal visible={fullEditModalVisible} transparent animationType="slide" onRequestClose={() => setFullEditModalVisible(false)}>
          ...
          <View style={styles.fullModalContent}>
            ...
            <ScrollView style={styles.fullModalBody} showsVerticalScrollIndicator={false}>
              ...
              <View style={styles.inputGroup}>
                ...
                <TextInput style={styles.input} value={editForm.shipName} onChangeText={(val) => setEditForm(prev => ({ ...prev, shipName: val }))} placeholder="Ship name" placeholderTextColor={COLORS.textSecondary}/>
              </View>

              <View style={styles.inputGroup}>
                <Text style={styles.inputLabel}>Destination / Itinerary</Text>
                <TextInput style={styles.input} value={editForm.destination} onChangeText={(val) => setEditForm(prev => ({ ...prev, destination: val }))} placeholder="Destination" placeholderTextColor={COLORS.textSecondary}/>
              </View>

              <View style={styles.inputRow}>
                <View style={[styles.inputGroup, { flex: 1 }]}>
                  <Text style={styles.inputLabel}>Departure Port</Text>
                  <TextInput style={styles.input} value={editForm.departurePort} onChangeText={(val) => setEditForm(prev => ({ ...prev, departurePort: val }))} placeholder="Port" placeholderTextColor={COLORS.textSecondary}/>
                </View>
                <View style={[styles.inputGroup, { flex: 1, marginLeft: SPACING.md }]}>
                  <Text style={styles.inputLabel}>Nights</Text>
                  <TextInput style={styles.input} value={editForm.nights} onChangeText={(val) => setEditForm(prev => ({ ...prev, nights: val }))} keyboardType="numeric" placeholder="# Nights" placeholderTextColor={COLORS.textSecondary}/>
                </View>
              </View>
              ...
              <View style={styles.inputRow}>
                <View style={[styles.inputGroup, { flex: 1 }]}>
                  ...
                  <TextInput style={styles.input} value={editForm.sailDate} onChangeText={(val) => setEditForm(prev => ({ ...prev, sailDate: val }))} placeholder="2025-01-15" placeholderTextColor={COLORS.textSecondary}/>
                </View>
                <View style={[styles.inputGroup, { flex: 1, marginLeft: SPACING.md }]}>
                  <Text style={styles.inputLabel}>Guests</Text>
                  <TextInput style={styles.input} value={editForm.guests} onChangeText={(val) => setEditForm(prev => ({ ...prev, guests: val }))} keyboardType="numeric" placeholder="2" placeholderTextColor={COLORS.textSecondary}/>
                </View>
              </View>

              <View style={styles.inputGroup}>
                <Text style={styles.inputLabel}>Cabin Type</Text>
                <TextInput style={styles.input} value={editForm.cabinType} onChangeText={(val) => setEditForm(prev => ({ ...prev, cabinType: val }))} placeholder="Balcony, Suite, etc." placeholderTextColor={COLORS.textSecondary}/>
              </View>
              ...
              <View style={styles.inputRow}>
                <View style={[styles.inputGroup, { flex: 1 }]}>
                  ...
                  <TextInput style={styles.input} value={editForm.interiorPrice} onChangeText={(val) => setEditForm(prev => ({ ...prev, interiorPrice: val }))} keyboardType="numeric" placeholder="0" placeholderTextColor={COLORS.textSecondary}/>
                </View>
                <View style={[styles.inputGroup, { flex: 1, marginLeft: SPACING.md }]}>
                  <Text style={styles.inputLabel}>Ocean View ($)</Text>
                  <TextInput style={styles.input} value={editForm.oceanviewPrice} onChangeText={(val) => setEditForm(prev => ({ ...prev, oceanviewPrice: val }))} keyboardType="numeric" placeholder="0" placeholderTextColor={COLORS.textSecondary}/>
                </View>
              </View>
              ...
              <View style={styles.inputRow}>
                <View style={[styles.inputGroup, { flex: 1 }]}>
                  ...
                  <TextInput style={styles.input} value={editForm.balconyPrice} onChangeText={(val) => setEditForm(prev => ({ ...prev, balconyPrice: val }))} keyboardType="numeric" placeholder="0" placeholderTextColor={COLORS.textSecondary}/>
                </View>
                <View style={[styles.inputGroup, { flex: 1, marginLeft: SPACING.md }]}>
                  <Text style={styles.inputLabel}>Suite ($)</Text>
                  <TextInput style={styles.input} value={editForm.suitePrice} onChangeText={(val) => setEditForm(prev => ({ ...prev, suitePrice: val }))} keyboardType="numeric" placeholder="0" placeholderTextColor={COLORS.textSecondary}/>
                </View>
              </View>

              <View style={styles.inputGroup}>
                <Text style={styles.inputLabel}>Taxes & Fees ($)</Text>
                <TextInput style={styles.input} value={editForm.taxes} onChangeText={(val) => setEditForm(prev => ({ ...prev, taxes: val }))} keyboardType="numeric" placeholder="0" placeholderTextColor={COLORS.textSecondary}/>
              </View>
              ...
              <View style={styles.inputGroup}>
                ...
                <TextInput style={styles.input} value={editForm.bwoNumber} onChangeText={(val) => setEditForm(prev => ({ ...prev, bwoNumber: val }))} placeholder="e.g., 2501A01" placeholderTextColor={COLORS.textSecondary}/>
              </View>

              <View style={styles.inputRow}>
                <View style={[styles.inputGroup, { flex: 1 }]}>
                  <Text style={styles.inputLabel}>FreePlay ($)</Text>
                  <TextInput style={styles.input} value={editForm.freePlay} onChangeText={(val) => setEditForm(prev => ({ ...prev, freePlay: val }))} keyboardType="numeric" placeholder="0" placeholderTextColor={COLORS.textSecondary}/>
                </View>
                <View style={[styles.inputGroup, { flex: 1, marginLeft: SPACING.md }]}>
                  <Text style={styles.inputLabel}>OBC ($)</Text>
                  <TextInput style={styles.input} value={editForm.freeOBC} onChangeText={(val) => setEditForm(prev => ({ ...prev, freeOBC: val }))} keyboardType="numeric" placeholder="0" placeholderTextColor={COLORS.textSecondary}/>
                </View>
              </View>
              ...
              <View style={styles.inputRow}>
                <View style={[styles.inputGroup, { flex: 1 }]}>
                  ...
                  <TextInput style={styles.input} value={editForm.tradeInValue} onChangeText={(val) => setEditForm(prev => ({ ...prev, tradeInValue: val }))} keyboardType="numeric" placeholder="0" placeholderTextColor={COLORS.textSecondary}/>
                </View>
                <View style={[styles.inputGroup, { flex: 1, marginLeft: SPACING.md }]}>
                  <Text style={styles.inputLabel}>Next Cruise Cert ($)</Text>
                  <TextInput style={styles.input} value={editForm.nextCruiseCertificate} onChangeText={(val) => setEditForm(prev => ({ ...prev, nextCruiseCertificate: val }))} keyboardType="numeric" placeholder="0" placeholderTextColor={COLORS.textSecondary}/>
                </View>
              </View>

              <View style={styles.inputGroup}>
                <Text style={styles.inputLabel}>Amount Paid ($)</Text>
                <TextInput style={styles.input} value={editForm.amountPaid} onChangeText={(val) => setEditForm(prev => ({ ...prev, amountPaid: val }))} keyboardType="numeric" placeholder="0" placeholderTextColor={COLORS.textSecondary}/>
              </View>
              ...
              <View style={[styles.switchRow, { backgroundColor: 'rgba(59,130,246,0.10)', borderRadius: 10, marginBottom: 6 }]}>
                ...
                <Switch value={editForm.singleOccupancy} onValueChange={(val) => setEditForm(prev => ({ ...prev, singleOccupancy: val }))} trackColor={{ false: 'rgba(255,255,255,0.2)', true: '#3B82F6' }} thumbColor={COLORS.white}/>
              </View>

              <View style={styles.switchRow}>
                <Text style={styles.switchLabel}>Free Gratuities</Text>
                <Switch value={editForm.freeGratuities} onValueChange={(val) => setEditForm(prev => ({ ...prev, freeGratuities: val }))} trackColor={{ false: 'rgba(255,255,255,0.2)', true: COLORS.success }} thumbColor={COLORS.white}/>
              </View>

              <View style={styles.switchRow}>
                <Text style={styles.switchLabel}>Free Drink Package</Text>
                <Switch value={editForm.freeDrinkPackage} onValueChange={(val) => setEditForm(prev => ({ ...prev, freeDrinkPackage: val }))} trackColor={{ false: 'rgba(255,255,255,0.2)', true: COLORS.success }} thumbColor={COLORS.white}/>
              </View>

              <View style={styles.switchRow}>
                <Text style={styles.switchLabel}>Free WiFi</Text>
                <Switch value={editForm.freeWifi} onValueChange={(val) => setEditForm(prev => ({ ...prev, freeWifi: val }))} trackColor={{ false: 'rgba(255,255,255,0.2)', true: COLORS.success }} thumbColor={COLORS.white}/>
              </View>

              <View style={styles.switchRow}>
                <Text style={styles.switchLabel}>Free Specialty Dining</Text>
                <Switch value={editForm.freeSpecialtyDining} onValueChange={(val) => setEditForm(prev => ({ ...prev, freeSpecialtyDining: val }))} trackColor={{ false: 'rgba(255,255,255,0.2)', true: COLORS.success }} thumbColor={COLORS.white}/>
              </View>
              ...
              <View style={styles.inputRow}>
                <View style={[styles.inputGroup, { flex: 1 }]}>
                  <Text style={styles.inputLabel}>Won/Loss ($)</Text>
                  <TextInput style={styles.input} value={editForm.winnings} onChangeText={(val) => setEditForm(prev => ({ ...prev, winnings: val }))} keyboardType="numeric" placeholder="0" placeholderTextColor={COLORS.textSecondary}/>
                </View>
                <View style={[styles.inputGroup, { flex: 1, marginLeft: SPACING.md }]}>
                  <Text style={styles.inputLabel}>Points Earned</Text>
                  <TextInput style={styles.input} value={editForm.earnedPoints} onChangeText={(val) => setEditForm(prev => ({ ...prev, earnedPoints: val }))} keyboardType="numeric" placeholder="0" placeholderTextColor={COLORS.textSecondary}/>
                </View>
              </View>
      ...
      <Modal visible={unbookModalVisible} transparent animationType="fade" onRequestClose={() => setUnbookModalVisible(false)}>
        <View style={styles.modalOverlay}>
          <View style={styles.modalContent}>
            <View style={styles.modalHeader}>
            ...
            <View style={styles.modalFooter}>
              ...
              <TouchableOpacity style={styles.unbookConfirmButton} onPress={() => {
            if (cruise?.id) {
