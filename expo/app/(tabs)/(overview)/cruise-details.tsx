        ...
        <View style={styles.content}>
          ...
          <View style={styles.topItineraryCard} testID="cruise-details-top-itinerary">
            <View style={styles.topItineraryHeader}>
              ...
              <Text style={styles.topItinerarySource} numberOfLines={1}>{itineraryDisplay.source.replace(/\./g, ' ')}</Text>
            </View>
            ...
            <View style={styles.cruiseDetailsSection}>
              ...
              <View style={styles.detailsGrid}>
                ...
                <View style={styles.detailRow} testID="cruise-detail-stateroom-type">
                  ...
                  <Text style={styles.detailRowValue}>{(cruise as BookedCruise).stateroomType || cruise.cabinType || (cruise as any).cabinCategory || '—'}</Text>
                </View>
