...
import { COLORS, SPACING, BORDER_RADIUS, TYPOGRAPHY, CLEAN_THEME, SHADOW, DS } from '@/constants/theme';
...
const styles = StyleSheet.create({
  ...
  cleanCardRose: {
    ...
    borderColor: DS.accent.alert,
  },
  sectionAccentGold: {
    borderLeftWidth: 3,
    borderLeftColor: DS.accent.warning,
    paddingLeft: 6,
    borderRadius: DS.radius.sm,
  },
  sectionAccentEmerald: {
    borderLeftWidth: 3,
    borderLeftColor: DS.accent.success,
    paddingLeft: 6,
    borderRadius: DS.radius.sm,
  },
  sectionAccentPurple: {
    borderLeftWidth: 3,
    borderLeftColor: '#A070CC',
    paddingLeft: 6,
    borderRadius: DS.radius.sm,
  },
  sectionAccentRose: {
    borderLeftWidth: 3,
    borderLeftColor: DS.accent.alert,
    paddingLeft: 6,
    borderRadius: DS.radius.sm,
  },
  sectionAccentOrange: {
  ...
  casinoPerformanceHeader: {
    ...
    padding: SPACING.md,
    borderBottomWidth: 1,
    borderBottomColor: DS.accent.warning,
  },
