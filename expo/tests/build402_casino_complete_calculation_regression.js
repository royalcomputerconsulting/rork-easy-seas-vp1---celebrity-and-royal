...
const currentTruth = current.map((cruise) => truth.buildCasinoCruiseTruth({ cruise, pointsPerHourFallback: 400, houseEdgeFallback: 0.08 }));
...
assert.match(economics, /totalEconomicValue = round2\(cruiseValueCaptured \+ cashResult\)/);
