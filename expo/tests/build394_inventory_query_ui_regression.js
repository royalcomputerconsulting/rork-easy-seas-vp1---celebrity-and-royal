...
assert.match(settings, /cruises: cruiseInventoryCount \|\| cruises\.length \|\| 0/);
...
assert.match(settings, /cruises: \[\],[\s\S]*Available cruises remain query-backed in SQLite/);
...
assert.match(scheduling, /onEndReachedThreshold=\{0\.6\}/);
...
assert.match(offerDetails, /onEndReached/);
...
assert.match(dataBundle, /replaceCatalog\(replacementRows/);
