...
const certificateResults = optimizeCertificateRedemption([{ shipName: 'Icon of the Seas', sailDate: '2026-09-26', decisionGuide: [], levels: [{ certificateCode: '2607A02A', certificateType: 'A', level: '02A', points: 1200, departurePort: 'Miami', itinerary: 'Caribbean', offerTypeLabel: '2 guests', guestCount: 2, cabinLabel: 'Interior', freePlay: 500, onBoardCredit: 100, benefitSummary: [], pdfUrl: 'local', monthlyIndexUrl: 'local' }] }], { certificateCode: '2607A02A', taxesBySailing: { 'icon of the seas__2026-09-26': 200 }, airfareBySailing: { 'icon of the seas__2026-09-26': 300 }, upgradeBySailing: { 'icon of the seas__2026-09-26': 0 } }, new Date('2026-08-22'));
