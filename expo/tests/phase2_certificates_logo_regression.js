...
(async () => {
  ...
  assert.match(overview, /resizeMode="contain"/, 'the non-negotiable Easy Seas logo must remain fully visible without cropping');
  assert.match(overview, /offersHeroImageCard:[\s\S]{0,180}height: 90/, 'the compact logo treatment must remain visible without recreating the former oversized header');
