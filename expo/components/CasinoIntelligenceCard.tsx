    ...
    <View style={styles.section}>
      <View style={styles.sectionHeader}>
        <View style={[styles.sectionIcon, { backgroundColor: 'rgba(16, 185, 129, 0.15)' }]}>
          <BarChart3 size={16} color="#4EC0A5" />
        </View>
      ...
      <View style={styles.content}>
        ...
        {cruiseMetrics && (
          <View style={styles.section}>
            <View style={styles.sectionHeader}>
              <View style={[styles.sectionIcon, { backgroundColor: 'rgba(16, 185, 129, 0.15)' }]}>
                <TrendingUp size={16} color="#4EC0A5" />
              </View>
            ...
            <View style={styles.predictiveGrid}>
              ...
              <View style={styles.predictiveCard}>
                ...
                <Text style={[
                  styles.predictiveValue,
                  { color: cruiseMetrics.predictiveScore >= 50 ? COLORS.success : cruiseMetrics.predictiveScore >= 30 ? '#E6B63D' : COLORS.error }
                ]}>
