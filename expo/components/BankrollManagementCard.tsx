...
export function BankrollManagementCard({
  ...
  const getProgressColor = (percentUsed: number): string => {
    if (percentUsed >= 90) return '#A52B34';
    if (percentUsed >= 75) return '#E6B63D';
    if (percentUsed >= 50) return '#E6B63D';
    return '#4EC0A5';
  };
    ...
    return (
      <View style={styles.compactContainer}>
        <View style={styles.compactHeader}>
          <DollarSign size={16} color="#A52B34" />
    ...
    <View style={styles.container}>
      ...
      >
        <View style={styles.headerContent}>
          <View style={styles.headerIcon}>
            <DollarSign size={20} color="#A52B34" />
          </View>
      ...
      <View style={styles.content}>
        ...
        <View style={styles.helpSection}>
          <TrendingDown size={16} color="#A52B34" />
