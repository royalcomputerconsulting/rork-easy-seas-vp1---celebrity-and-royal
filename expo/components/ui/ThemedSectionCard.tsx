...
const TONE_COLORS: Record<Exclude<SectionTone, 'default'>, { accent: string; soft: string }> = {
  info: { accent: '#2C64A0', soft: '#E8F1FA' },
  success: { accent: '#237A4B', soft: '#E7F5EC' },
  warning: { accent: '#A86B00', soft: '#FFF4D6' },
  casino: { accent: '#17324D', soft: '#E8F1FA' },
  weather: { accent: '#167C80', soft: '#DFF2EF' },
};
...
const styles = StyleSheet.create({
  ...
  content: { position: 'relative', padding: EASY_SEAS_COMPONENT_TOKENS.cardPadding, paddingTop: 14, overflow: 'hidden' },
  contentAccent: {
    position: 'absolute',
    left: 0,
    top: 0,
