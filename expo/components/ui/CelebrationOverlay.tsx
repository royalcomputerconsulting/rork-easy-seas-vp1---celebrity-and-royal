...
export function CelebrationOverlay({
  ...
  }, [motionDuration, particleAnims, preferences.reducedMotion]);
  ...
  }, [motionDuration, opacityAnim, onDismiss, preferences.reducedMotion, scaleAnim]);
  ...
  useEffect(() => {
    if (visible) {
      ...
      if (preferences.reducedMotion) {
        ...
        const reducedTimer = setTimeout(onDismiss, 1200);
      ...
      const timer = setTimeout(() => {
        dismissAnimation();
      }, Math.min(autoHideDuration, 2200));

      return () => clearTimeout(timer);
    }
  }, [visible, triggerHaptics, animateParticles, dismissAnimation, autoHideDuration, scaleAnim, opacityAnim, iconScaleAnim, iconRotateAnim, shineAnim, motionDuration, onDismiss, preferences.reducedMotion]);
  ...
  const getGradientColors = () => {
    switch (type) {
      ...
      case 'milestone':
        return ['#4EC0A5', '#4EC0A5', '#6EE7B7'] as const;
      default:
  ...
  const particleColors = ['#FFD700', '#FFA500', '#FF6B00', '#9333EA', '#4EC0A5', '#F97316'];
