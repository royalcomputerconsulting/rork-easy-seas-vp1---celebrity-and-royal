...
export const TierBadge = React.memo(function TierBadge({
  ...
  if (onPress) {
    return (
      <TouchableOpacity onPress={onPress} activeOpacity={0.7} style={styles.touchTarget} accessibilityRole="button" accessibilityLabel={`Open ${type === 'clubRoyale' ? 'Club Royale' : 'Crown and Anchor'} ${tier} details`}>
