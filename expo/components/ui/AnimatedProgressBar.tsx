...
export function AnimatedProgressBar({ progress, label, value, sublabel, showPercentage = true, height = 10, color, gradientColors, backgroundColor = 'rgba(255,255,255,0.1)', eta, animated = true, showGlow = true, milestones = [], }: AnimatedProgressBarProps) {
    ...
    return (<Animated.View style={[styles.container, { transform: [{ scale: pulseAnim }] }]}>
      ...
      <View style={[styles.track, { height, backgroundColor }]}>
        {milestones.map((milestone, index) => (<View key={index} style={[
                styles.milestone,
                { left: `${milestone}%` },
        ...
        <Animated.View style={[styles.fillContainer, { width: widthInterpolation, height }]}>
          <LinearGradient colors={fillColors as [
        string,
        string,
        ...string[]
    ]} start={{ x: 0, y: 0 }} end={{ x: 1, y: 0 }} style={[styles.fill, { height }]}/>
