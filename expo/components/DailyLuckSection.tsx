...
export function DailyLuckSection({ selectedDate }: DailyLuckSectionProps) {
  ...
  const barColor = LUCK_SCORE_BAR_COLOR[luckLevel] ?? '#3D87BF';
        ...
        >
          <View style={styles.zodiacHeader}>
            ...
            <View style={styles.zodiacRightGroup}>
              <View style={[styles.zodiacScorePill, { backgroundColor: 'rgba(125,211,252,0.16)' }]}>
                <Text style={[styles.zodiacScoreText, { color: '#3D87BF' }]}>{westernScore}/9</Text>
              </View>
              {westernExpanded
          ...
          {westernExpanded ? (
            <View style={styles.detailedSection}>
              ...
              <SectionDivider color="#3D87BF" />

              <View style={styles.detailedSubHeader}>
                <Briefcase size={13} color="#3D87BF" />
              ...
              <View style={styles.detailedScoreRow}>
                ...
                <Text style={[styles.detailedScoreValue, { color: '#3D87BF' }]}>{westernScore} / 9</Text>
              </View>
          ...
          <ScoreBar value={westernScore} color="#3D87BF" />
        </LinearGradient>
      </TouchableOpacity>
      ...
      >
        ...
        <View style={styles.finalCalcBreakdown}>
          <View style={styles.finalCalcRow}>
            ...
            <Text style={[styles.finalCalcValue, { color: '#3D87BF' }]}>{finalCalc.westernScore}</Text>
          </View>
          <View style={styles.finalCalcRow}>
