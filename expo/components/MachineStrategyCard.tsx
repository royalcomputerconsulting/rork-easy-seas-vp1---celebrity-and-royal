...
interface MachineStrategyCardProps {
  showHeader?: boolean;
}

export function MachineStrategyCard({ showHeader = true }: MachineStrategyCardProps) {
          ...
          {bestMachine && (
            <View style={styles.highlightBox}>
              <View style={styles.highlightHeader}>
                <Zap size={18} color="#E6B63D" fill="#E6B63D" />
      ...
      <View style={styles.recContent}>
        ...
        <View style={styles.recStats}>
          <View style={styles.recStat}>
            {isPositive ? (
              <TrendingUp size={14} color="#4EC0A5" />
            ) : (
              <TrendingDown size={14} color="#A52B34" />
            )}
        ...
        <View style={styles.recFooter}>
          ...
          <View style={styles.recStat}>
            <DollarSign size={12} color="#8E8A89" />
            <Text style={styles.recFooterText}>
