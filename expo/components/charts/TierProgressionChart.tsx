...
export function TierProgressionChart({ playerContext, bookedCruises, monthsAhead = 24, }: TierProgressionChartProps) {
    const projections = useMemo(() => generateTimelineProjections(playerContext, bookedCruises, monthsAhead), [playerContext, bookedCruises, monthsAhead]);
      ...
      <View style={styles.content}>
        ...
        <View style={styles.chartSection}>
          <View style={[styles.chart, { height: CHART_HEIGHT }]}>
            {chartData.tierLines.map((line) => (<View key={line.tier} style={styles.tierLineContainer}>
                <View style={[
                styles.tierLine,
