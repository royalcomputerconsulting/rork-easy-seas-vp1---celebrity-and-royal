...
const RARITY_COLORS = {
  common: { bg: '#676A70', light: 'rgba(107, 114, 128, 0.15)' },
  rare: { bg: '#3B82F6', light: 'rgba(59, 130, 246, 0.15)' },
  epic: { bg: '#8B5CF6', light: 'rgba(139, 92, 246, 0.15)' },
  legendary: { bg: '#E6B63D', light: 'rgba(245, 158, 11, 0.15)' },
};
...
function StreakDisplay({ streak }: { streak: PlayingStreak }) {
  ...
  useEffect(() => {
    if (streak.currentDailyStreak > 0 && !preferences.reducedMotion) {
  ...
  }, [streak.currentDailyStreak, flameScale, motionDuration, preferences.reducedMotion]);
          ...
          <View style={styles.streakRow}>
            <View style={[styles.streakIconContainer, { backgroundColor: 'rgba(249, 115, 22, 0.15)' }]}>
              <Animated.View style={{ transform: [{ scale: flameScale }] }}>
                <Flame 
                  size={16} 
                  color={isStreakAlive ? '#F97316' : '#8E8A89'} 
  ...
  return (
    ...
    >
      <View style={[
        ...
        { backgroundColor: isUnlocked ? rarityColors.bg : '#8E8A89' },
      ]}>
        {isUnlocked ? (
