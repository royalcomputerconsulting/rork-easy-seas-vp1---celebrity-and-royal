...
export const CompactDashboardHeader = React.memo(function CompactDashboardHeader({ memberName = 'Player', crownAnchorNumber, onSettingsPress, onAlertsPress, onLogoutPress, alertCount = 0, availableCruises = 0, bookedCruises = 0, activeOffers = 0, onCruisesPress, onBookedPress, onOffersPress, hideLogo = false, crewMemberCount = 0, }: CompactDashboardHeaderProps) {
    const { clubRoyalePoints, clubRoyaleTier, crownAnchorPoints, crownAnchorLevel, pinnacleProgress, mastersProgress, projectedBookedPoints, } = useLoyalty();
    ...
    return (<LinearGradient colors={marbleConfig.gradientColors as unknown as [
      ...
      <View style={styles.progressGrid}>
        ...
        {(() => {
              ...
              <View style={styles.progressHeader}>
                ...
                {isPinnacle ? (<View style={styles.achievedBadge}>
                    <Text style={styles.achievedBadgeText}>MAX LEVEL</Text>
                  </View>) : (<Text style={styles.progressPercent}>{percentComplete.toFixed(1)}%</Text>)}
              </View>
              <View style={styles.progressBarBg}>
                <LinearGradient colors={[levelColor, nextLevelColor]} start={{ x: 0, y: 0 }} end={{ x: 1, y: 0 }} style={[styles.progressBarFill, { width: `${Math.min(100, percentComplete)}%` }]}/>
              </View>
        ...
        {(() => {
              ...
              <View style={styles.progressHeader}>
                ...
                {isMasters ? (<View style={styles.achievedBadge}>
                    <Text style={styles.achievedBadgeText}>MAX TIER</Text>
                  </View>) : (<Text style={styles.progressPercent}>{percentComplete.toFixed(1)}%</Text>)}
              </View>
              <View style={styles.progressBarBg}>
                <LinearGradient colors={[tierColor, nextTierColor]} start={{ x: 0, y: 0 }} end={{ x: 1, y: 0 }} style={[styles.progressBarFill, { width: `${Math.min(100, percentComplete)}%` }]}/>
              </View>
              <Text style={styles.progressEta}>
                {isMasters
        ...
        {(() => {
                ...
                return (<View style={[styles.progressCard, styles.achievedCard]}>
              <View style={styles.progressHeader}>
              ...
              <View style={styles.progressBarBg}>
                <LinearGradient colors={[priorTierColor, currentTierColor]} start={{ x: 0, y: 0 }} end={{ x: 1, y: 0 }} style={[styles.progressBarFill, { width: '100%' }]}/>
              </View>
              <Text style={styles.progressEta}>
      ...
      <View style={styles.quickStatsPillRow}>
        <TouchableOpacity style={styles.quickStatPill} onPress={onCruisesPress} activeOpacity={0.7}>
        ...
        <TouchableOpacity style={styles.quickStatPill} onPress={onBookedPress} activeOpacity={0.7}>
        ...
        <TouchableOpacity style={styles.quickStatPill} onPress={onOffersPress} activeOpacity={0.7}>
      ...
      <View style={styles.progressGrid}>
        {(() => {
              ...
              <View style={styles.progressHeader}>
                ...
                {isZenith ? (<View style={styles.achievedBadge}>
                    <Text style={styles.achievedBadgeText}>MAX LEVEL</Text>
                  </View>) : (<Text style={styles.progressPercent}>{percentComplete.toFixed(1)}%</Text>)}
              </View>
              <View style={styles.progressBarBg}>
        ...
        {(() => {
              ...
              <View style={styles.progressHeader}>
                ...
                {isRuby ? (<View style={styles.achievedBadge}>
                    <Text style={styles.achievedBadgeText}>MAX TIER</Text>
                  </View>) : (<Text style={styles.progressPercent}>--</Text>)}
              </View>
              <View style={styles.progressBarBg}>
                <LinearGradient colors={[tierColor, nextTierColor]} start={{ x: 0, y: 0 }} end={{ x: 1, y: 0 }} style={[styles.progressBarFill, { width: isRuby ? '100%' : '0%' }]}/>
              </View>
              <Text style={styles.progressEta}>
                {isRuby
      ...
      <View style={styles.progressGrid}>
        {(() => {
              ...
              <View style={styles.progressHeader}>
                ...
                {isMax ? (<View style={styles.achievedBadge}>
                    <Text style={styles.achievedBadgeText}>MAX TIER</Text>
                  </View>) : (<Text style={styles.progressPercent}>{percentComplete.toFixed(1)}%</Text>)}
              </View>
              <View style={styles.progressBarBg}>
      ...
      <View style={styles.progressGrid}>
        {(() => {
              ...
              <View style={styles.progressBarBg}>
                <LinearGradient colors={[tierColor, nextTierColor]} start={{ x: 0, y: 0 }} end={{ x: 1, y: 0 }} style={[styles.progressBarFill, { width: isMax ? '100%' : '0%' }]}/>
              </View>
              <Text style={styles.progressEta}>
                {isMax
