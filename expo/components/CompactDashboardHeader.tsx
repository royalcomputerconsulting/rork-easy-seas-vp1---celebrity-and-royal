    ...
    >
      ...
      <View style={[styles.progressGrid, compact && styles.progressGridCompact]}>
        ...
        {(() => {
          ...
          const nextTierDescription = isPinnacle
          ...
          return (
            <View style={[styles.progressCard, compact && styles.progressCardCompact, progressCardStyle]}>
              <Text style={[styles.progressKicker, { color: playerCardTheme.accentColor }]}>CROWN &amp; ANCHOR</Text>
              ...
              <Text style={[styles.progressEta, progressMetaStyle]}>{nextTierDescription}</Text>
        ...
        {(() => {
          ...
          return (
            <View style={[styles.progressCard, compact && styles.progressCardCompact, progressCardStyle]}>
              <Text style={[styles.progressKicker, { color: playerCardTheme.accentColor }]}>CLUB ROYALE · CURRENT SEASON</Text>
              <View style={styles.progressHeadlineRow}>
                <View style={styles.progressHeadlineCopy}>
                  <Text style={[styles.progressLabel, progressLabelStyle]}>
