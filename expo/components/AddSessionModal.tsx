        ...
        >
          {goldenTimeSlots.length > 0 && (
            <View style={styles.section}>
              ...
              <TouchableOpacity
                ...
                activeOpacity={0.7}
              >
                <Clock size={18} color={customMode ? COLORS.white : '#16755F'} />
                <Text style={[
          ...
          >
            <View style={styles.bankrollToggleContent}>
              <DollarSign size={18} color="#16755F" />
            ...
            <>
              <View style={styles.section}>
                ...
                >
                  ...
                  <ChevronDown size={18} color="#676A70" />
                </TouchableOpacity>
              ...
              <View style={styles.section}>
                ...
                {calculatedWinLoss !== null && (
                  <View style={[
                    ...
                    <Text style={[
                      styles.winLossValue,
                      { color: calculatedWinLoss >= 0 ? '#16755F' : '#A52B34' }
                    ]}>
