...
export function AddSessionModal({ visible, onClose, onSave, date, goldenTimeSlots, }: AddSessionModalProps) {
    ...
    return (<Modal visible={visible} animationType="slide" presentationStyle="pageSheet" onRequestClose={handleClose}>
      <KeyboardAvoidingView style={styles.container} behavior={Platform.OS === 'ios' ? 'padding' : undefined}>
        ...
        <ScrollView style={styles.content} contentContainerStyle={styles.contentContainer} showsVerticalScrollIndicator={false}>
          ...
          <TouchableOpacity style={styles.bankrollToggle} onPress={() => setShowBankrollSection(!showBankrollSection)} activeOpacity={0.7}>
            <View style={styles.bankrollToggleContent}>
              <DollarSign size={18} color="#059669"/>
              <Text style={styles.bankrollToggleText}>Bankroll Tracking</Text>
            </View>
            <ChevronDown size={18} color="#059669" style={{ transform: [{ rotate: showBankrollSection ? '180deg' : '0deg' }] }}/>
          </TouchableOpacity>
        ...
        <View style={styles.footer}>
          <TouchableOpacity style={styles.saveButton} onPress={handleSave} activeOpacity={0.8}>
            <LinearGradient colors={['#10B981', '#059669']} start={{ x: 0, y: 0 }} end={{ x: 1, y: 0 }} style={styles.saveButtonGradient}>
