...
const styles = StyleSheet.create({ card: { backgroundColor: '#FFFFFF', borderRadius: 16, padding: 14, borderWidth: 1, borderColor: '#DDE7F5' }, title: { fontWeight: '800', color: '#123D73' }, metric: { marginTop: 6, fontWeight: '900', color: '#16755F', fontSize: 18 }, body: { marginTop: 6, color: '#334155' } });
