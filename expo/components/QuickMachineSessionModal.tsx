...
export default function QuickMachineSessionModal({ visible, onClose, cruiseId, shipName, }: QuickMachineSessionModalProps) {
    ...
    return (<Modal visible={visible} animationType="slide" transparent onRequestClose={handleClose}>
          ...
          <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
            ...
            <View style={styles.section}>
              ...
              <ScrollView style={styles.machineList} nestedScrollEnabled>
                {availableMachines.length === 0 ? (<Text style={styles.noMachines}>No machines available</Text>) : (availableMachines.map((machine) => (<TouchableOpacity key={machine.id} style={[
                styles.machineItem,
            ...
            <View style={styles.section}>
              ...
              <View style={styles.inputRow}>
                ...
                <TextInput style={styles.input} placeholder="Duration (minutes)" placeholderTextColor="#9ca3af" keyboardType="numeric" value={durationMinutes} onChangeText={setDurationMinutes}/>
              </View>
            </View>
            ...
            <View style={styles.section}>
              ...
              <View style={styles.denomRow}>
                {[0.01, 0.05, 0.25, 1].map((denom) => (<TouchableOpacity key={denom} style={[
                styles.denomChip,
            ...
            <View style={styles.section}>
              ...
              <View style={styles.inputRow}>
                ...
                <TextInput style={styles.input} placeholder="Buy-In" placeholderTextColor="#9ca3af" keyboardType="numeric" value={buyIn} onChangeText={setBuyIn}/>
              </View>

              <View style={styles.inputRow}>
                <DollarSign size={20} color="#6b7280" style={styles.inputIcon}/>
                <TextInput style={styles.input} placeholder="Cash-Out" placeholderTextColor="#9ca3af" keyboardType="numeric" value={cashOut} onChangeText={setCashOut}/>
              </View>
            ...
            <View style={styles.section}>
              ...
              <TextInput style={[styles.input, styles.textArea]} placeholder="Any notes about the session..." placeholderTextColor="#9ca3af" multiline numberOfLines={3} value={notes} onChangeText={setNotes}/>
            </View>
          </ScrollView>
