          ...
          <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
            ...
            <View style={styles.section}>
              ...
              <View style={styles.inputRow}>
                <Clock size={20} color="#676A70" style={styles.inputIcon} />
                <TextInput
                  style={styles.input}
            ...
            <View style={styles.section}>
              ...
              <View style={styles.inputRow}>
                <DollarSign size={20} color="#676A70" style={styles.inputIcon} />
                <TextInput
                  style={styles.input}
                  placeholder="Buy-In"
                  placeholderTextColor="#8E8A89"
