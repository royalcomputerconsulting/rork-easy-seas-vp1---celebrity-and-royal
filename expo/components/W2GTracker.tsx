...
import { FileText, Plus, X, Calendar, AlertCircle, } from 'lucide-react-native';
...
export function W2GTracker({ records, onAddRecord, onRemoveRecord }: W2GTrackerProps) {
    ...
    return (<>
      <LinearGradient colors={MARBLE_TEXTURES.lightBlue.gradientColors} locations={MARBLE_TEXTURES.lightBlue.gradientLocations} style={styles.container}>
      ...
      <Modal visible={showAddModal} transparent animationType="fade" onRequestClose={() => setShowAddModal(false)}>
        <View style={styles.modalOverlay}>
          <View style={styles.modalContent}>
            ...
            <ScrollView showsVerticalScrollIndicator={false}>
              ...
              <TextInput style={styles.input} value={newDate} onChangeText={setNewDate} placeholder="MM-DD-YYYY" placeholderTextColor={COLORS.textSecondary}/>

              <Text style={styles.formLabel}>Winning Amount *</Text>
              <View style={styles.valueInputContainer}>
                <Text style={styles.currencySymbol}>$</Text>
                <TextInput style={styles.valueInput} value={newAmount} onChangeText={setNewAmount} placeholder="1200.00" placeholderTextColor={COLORS.textSecondary} keyboardType="decimal-pad"/>
              </View>

              <Text style={styles.formLabel}>Federal Tax Withheld</Text>
              <View style={styles.valueInputContainer}>
                <Text style={styles.currencySymbol}>$</Text>
                <TextInput style={styles.valueInput} value={newWithheld} onChangeText={setNewWithheld} placeholder="0.00" placeholderTextColor={COLORS.textSecondary} keyboardType="decimal-pad"/>
              </View>

              <Text style={styles.formLabel}>Description</Text>
              <TextInput style={styles.input} value={newDescription} onChangeText={setNewDescription} placeholder="e.g., Slot Machine Jackpot" placeholderTextColor={COLORS.textSecondary}/>

              <Text style={styles.formLabel}>Cruise/Location (Optional)</Text>
              <TextInput style={styles.input} value={newCruiseName} onChangeText={setNewCruiseName} placeholder="e.g., Harmony of the Seas" placeholderTextColor={COLORS.textSecondary}/>
        ...
        ]} onPress={handleAddRecord} disabled={!newAmount || parseFloat(newAmount) <= 0} activeOpacity={0.7}>
