...
export function UserManualModal({ visible, onClose }: UserManualModalProps) {
    ...
    return (<Modal visible={visible} animationType="slide" presentationStyle="pageSheet" onRequestClose={onClose}>
      <View style={styles.container}>
        ...
        <ScrollView ref={scrollViewRef} style={styles.scrollView} contentContainerStyle={styles.content} showsVerticalScrollIndicator={true}>
          ...
          <View style={styles.tocContainer}>
            ...
            {SECTIONS.map((section) => (<TouchableOpacity key={section.id} style={styles.tocItem} onPress={() => scrollToSection(section.id)}>
          ...
          <SectionWithRef id="quick-start" title="Quick Start Guide" onLayout={handleSectionLayout}>
          ...
          <SectionWithRef id="chrome-extensions" title="Chrome Extensions Setup" onLayout={handleSectionLayout}>
          ...
          <SectionWithRef id="data-import" title="Data Import Methods" onLayout={handleSectionLayout}>
          ...
          <SectionWithRef id="dashboard" title="Dashboard Overview" onLayout={handleSectionLayout}>
            <Paragraph>
          ...
          <SectionWithRef id="analytics" title="Analytics & Intelligence" onLayout={handleSectionLayout}>
            <Paragraph>
          ...
          <SectionWithRef id="machines" title="Machine Atlas" onLayout={handleSectionLayout}>
            <Paragraph>
          ...
          <SectionWithRef id="cruises" title="My Cruises" onLayout={handleSectionLayout}>
            <Paragraph>
          ...
          <SectionWithRef id="events" title="Events & Calendar" onLayout={handleSectionLayout}>
            <Paragraph>
          ...
          <SectionWithRef id="scheduling" title="Scheduling" onLayout={handleSectionLayout}>
            <Paragraph>
          ...
          <SectionWithRef id="settings" title="Settings Page (Complete Guide)" onLayout={handleSectionLayout}>
          ...
          <SectionWithRef id="loyalty" title="Loyalty Programs" onLayout={handleSectionLayout}>
...
function SectionWithRef({ id, title, children, onLayout }: SectionWithRefProps) {
    return (<View style={styles.section} onLayout={(event) => onLayout(id, event.nativeEvent.layout.y)}>
...
function Paragraph({ children, style }: {
    ...
    return <Text style={[styles.paragraph, style]}>{renderNodeInView(children, styles.paragraph)}</Text>;
}
function ImportantBox({ title, children }: {
    title: string;
    children: React.ReactNode;
}) {
    return (<View style={styles.importantBox}>
...
function FeatureList({ items }: {
    ...
    return (<View style={styles.featureList}>
      {items.map((item, index) => (<View key={index} style={styles.featureItem}>
...
function FieldList({ items }: {
    ...
    return (<View style={styles.fieldList}>
      {items.map((item, index) => (<View key={index} style={styles.fieldItem}>
...
function ButtonList({ items }: {
    ...
    return (<View style={styles.buttonList}>
      {items.map((item, index) => (<View key={index} style={styles.buttonItem}>
