...
export function WebCookieSyncModal({
  visible,
  onClose,
  onSubmit,
  cruiseLine,
          ...
          >
            <View style={styles.header}>
              <View style={[styles.iconContainer, isCelebrity && styles.iconContainerCelebrity, isCarnival && styles.iconContainerCarnival]}>
                <Cookie size={32} color={isCelebrity ? '#4EC0A5' : isCarnival ? '#CC2232' : '#3b82f6'} />
              </View>
            ...
            >
              <HelpCircle size={16} color="#3D87BF" />
            ...
            {showInstructions && (
              <View style={styles.instructionsContainer}>
                <Text style={styles.instructionsTitle}>How to get your cookies:</Text>
            ...
            <View style={styles.form}>
              <View style={styles.inputGroup}>
                ...
                <TextInput
                  ...
                  placeholder="Paste your cookies here (cookie1=value1; cookie2=value2; ...)"
              ...
              {error && (
                <View style={styles.errorContainer}>
                  <AlertCircle size={16} color="#A52B34" />
            ...
            <View style={styles.actions}>
              ...
              >
                {isLoading ? (
                  ...
                  <Text style={styles.submitButtonText}>Sync with Cookies</Text>
                )}
              </Pressable>
            </View>
          </ScrollView>
