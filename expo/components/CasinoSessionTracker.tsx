...
function AnimatedProgressRing({ 
  ...
  const animatedValue = useRef(new Animated.Value(preferences.reducedMotion ? percentage : 0)).current;
  ...
  }, [percentage, animatedValue, motionDuration, preferences.reducedMotion]);



  const progressColor = percentage >= 100 ? '#4EC0A5' : percentage >= 50 ? '#E6B63D' : '#3B82F6';
          ...
          <>
              ...
              <View style={styles.statsGrid}>
                ...
                <View style={styles.statItem}>
                  <View style={[styles.statIcon, { backgroundColor: 'rgba(245, 158, 11, 0.15)' }]}>
                    <TrendingUp size={16} color="#E6B63D" />
                  </View>
            ...
            {onViewDetails && (
              ...
              >
                ...
                <ChevronRight size={18} color="#16755F" />
              </TouchableOpacity>
            )}
          </>
        ) : (
