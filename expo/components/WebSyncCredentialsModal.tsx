...
export function WebSyncCredentialsModal({ visible, onClose, onSubmit, cruiseLine, isLoading, error }: WebSyncCredentialsModalProps) {
    ...
    return (<Modal visible={visible} transparent animationType="fade" onRequestClose={handleClose}>
      <View style={styles.overlay}>
          ...
          <View style={styles.form}>
            <View style={styles.inputGroup}>
              ...
              <View style={styles.inputContainer}>
                ...
                <TextInput style={styles.input} value={username} onChangeText={setUsername} placeholder="Enter your email" placeholderTextColor="#475569" autoCapitalize="none" autoCorrect={false} keyboardType="email-address" editable={!isLoading}/>
              </View>
            </View>
            ...
            <View style={styles.inputGroup}>
              ...
              <View style={styles.inputContainer}>
                ...
                <TextInput style={styles.input} value={password} onChangeText={setPassword} placeholder="Enter your password" placeholderTextColor="#475569" secureTextEntry={!showPassword} autoCapitalize="none" autoCorrect={false} editable={!isLoading}/>
        ...
        ]} onPress={handleSubmit} disabled={!username.trim() || !password.trim() || isLoading}>
              {isLoading ? (<ActivityIndicator size="small" color="#fff"/>) : (<Text style={styles.submitButtonText}>Sign In & Sync</Text>)}
            </Pressable>
          </View>
        </View>
      </View>
