...
export const PPHGoalsCard = React.memo(function PPHGoalsCard({
  ...
  const getStatusColor = useCallback((pph: number): string => {
    if (pph >= targetPPH * 1.2) return '#4EC0A5';
    if (pph >= targetPPH) return '#3B82F6';
    if (pph >= targetPPH * 0.7) return '#E6B63D';
    return '#A52B34';
  }, [targetPPH]);
    ...
    <View style={styles.container}>
      ...
      <View style={styles.content}>
            ...
            {currentStats.trend !== 0 && selectedPeriod !== 'all' && (
              <View style={styles.trendRow}>
                {currentStats.trend > 0 ? (
                  <TrendingUp size={12} color="#4EC0A5" />
                ) : (
                  <TrendingDown size={12} color="#A52B34" />
                )}
                <Text style={[
                  styles.trendText,
                  { color: currentStats.trend > 0 ? '#4EC0A5' : '#A52B34' }
                ]}>
        ...
        <View style={styles.statsGrid}>
          ...
          <View style={styles.statCard}>
            <BarChart3 size={16} color="#E6B63D" />
                  ...
                  {stats.trend !== 0 && period !== 'all' && (
                    <View style={[
                      ...
                      <Text style={[
                        ...
                        { color: stats.trend > 0 ? '#4EC0A5' : '#A52B34' }
                      ]}>
