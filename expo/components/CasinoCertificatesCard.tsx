...
import { ChevronRight, Sparkles, CircleDollarSign, Ticket, Gift, } from 'lucide-react-native';
...
export const CasinoCertificatesCard = React.memo(function CasinoCertificatesCard({ certificates, totalCertificates, availableCruises, onManagePress, onViewOffersPress, }: CasinoCertificatesCardProps) {
    ...
    return (<View style={styles.container}>
      <ImageBackground source={{ uri: CASINO_BG }} style={styles.backgroundImage} resizeMode="cover">
        <LinearGradient colors={['rgba(212, 160, 10, 0.88)', 'rgba(123, 45, 142, 0.92)']} start={{ x: 0, y: 0 }} end={{ x: 1, y: 1 }} style={styles.gradientOverlay}>
          ...
          <View style={styles.certificatesRow}>
            ...
            return (<View key={`${cert.type}-${index}`} style={styles.certificateItem}>
