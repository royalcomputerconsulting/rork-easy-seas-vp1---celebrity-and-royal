...
export function TimeZoneConverter({ embedded = false }: { embedded?: boolean } = {}) {
  ...
  return (
    <View style={styles.container}>
      <TouchableOpacity
        ...
        accessibilityLabel={`${expanded ? 'Hide' : 'Show'} time zone converter details`}
      >
        <View style={styles.headerLeft}>
          <View style={styles.iconBadge}>
            <Globe size={16} color="#0E7FA7" />
          </View>
          <Text style={styles.headerTitle}>{embedded ? (expanded ? 'Hide converter details' : 'Show converter details') : 'Time Zone Converter'}</Text>
        </View>
        ...
        <View style={styles.expandedContent}>
          <View style={styles.dualClockRow}>
            ...
            >
              ...
              <View style={styles.changeBtnRow}>
                ...
                <ChevronDown size={12} color="#0E7FA7" />
              </View>
            </TouchableOpacity>
            ...
            >
              ...
              <View style={styles.changeBtnRow}>
                ...
                <ChevronDown size={12} color="#E6B63D" />
              </View>
            </TouchableOpacity>
          </View>
          ...
          <View style={styles.meetingSection}>
            <View style={styles.meetingSectionHeader}>
              <CalendarClock size={14} color="#0E7FA7" />
