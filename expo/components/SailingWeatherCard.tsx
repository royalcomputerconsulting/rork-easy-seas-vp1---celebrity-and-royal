...
export function SailingWeatherCard({ cruise, selectedDate, showRefreshAction = false }: SailingWeatherCardProps) {
      ...
      >
        <View style={styles.topRow}>
          <View style={styles.headerBadge}>
            ...
            <Text style={styles.headerBadgeText}>Forecast & sea state</Text>
          </View>
        ...
        <Text style={styles.summary}>This card caches today’s wind and wave outlook for offline use.</Text>
      </LinearGradient>
    );
  }
  ...
  if (!forecast) {
    return (
      ...
      >
        ...
        {showRefreshAction ? <TouchableOpacity style={styles.refreshButton} onPress={() => void handleManualRefresh()} disabled={manualRefreshBusy} testID={`sailing-weather-refresh-${cruise.id}-${dateKey}`}>
  ...
  return (
    ...
    >
      ...
      {showRefreshAction ? <TouchableOpacity style={styles.refreshButton} onPress={() => void handleManualRefresh()} disabled={manualRefreshBusy} testID={`sailing-weather-refresh-${cruise.id}`}>
        {manualRefreshBusy ? <ActivityIndicator size="small" color="#071426" /> : <RefreshCw size={15} color="#071426" />}
