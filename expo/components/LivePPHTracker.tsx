        ...
        <View style={styles.pointsSection}>
          ...
          <View style={styles.pointsRow}>
            <TouchableOpacity
              ...
              activeOpacity={0.7}
            >
              <ChevronDown size={20} color="#A52B34" />
            ...
            <TouchableOpacity
              ...
              activeOpacity={0.7}
            >
              <ChevronUp size={20} color="#4EC0A5" />
              <Text style={styles.pointsButtonText}>+10</Text>
            </TouchableOpacity>
          </View>
          ...
          {!isTracking && elapsedSeconds === 0 ? (
            ...
            <>
              ...
              <TouchableOpacity
                ...
                activeOpacity={0.8}
              >
                <RotateCcw size={20} color="#676A70" />
