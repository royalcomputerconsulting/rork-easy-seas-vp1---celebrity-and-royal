...
export function CertificateExplorerModal({ visible, onClose }: CertificateExplorerModalProps) {
  ...
  }, [shipQuery, monthCode, sailDate, includeA, includeC, addLog, refreshCertificateDocuments]);
                    ...
                    <View key={`${sailing.certificateCode}-${sailing.sourceGroup}-${sailing.shipName}-${sailing.sailingDate}-${sailing.cabinCategory ?? ''}`} style={styles.levelRow}>
                      <View style={styles.levelContent}>
                        ...
                        <View style={styles.benefitChipRow}>
                          ...
                          <View style={styles.benefitChip}><Text style={styles.benefitChipText}>{formatGuestEligibility(sailing.guestCount ?? sailing.occupancy, 'Guests not stated')}</Text></View>
