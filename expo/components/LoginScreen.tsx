...
import { COLORS, SPACING, TYPOGRAPHY, EASY_SEAS_UX, EASY_SEAS_TYPE_STYLES } from '@/constants/theme';
...
export function LoginScreen() {
  ...
  return (
    <LinearGradient
      colors={[EASY_SEAS_UX.color.ivory, EASY_SEAS_UX.color.sky, EASY_SEAS_UX.color.seafoam]}
      ...
      >
        ...
        >
          ...
          <View style={styles.card}>
            <Text style={styles.accessEyebrow}>PRIVATE, DEVICE-PROTECTED ACCESS</Text>
            <Text style={styles.accessTitle}>{credentialMode === 'create' ? 'Create secure access' : 'Welcome back'}</Text>
            <Text style={styles.accessSummary}>Your saved voyages and casino records stay separated by account on this device.</Text>
            ...
            <TextInput
              ...
              accessibilityLabel="Easy Seas account email"
            />
            ...
            <TextInput
              ...
              accessibilityLabel={credentialMode === 'create' ? 'Create six-digit device PIN' : 'Enter six-digit device PIN'}
            />
            ...
            {credentialMode === 'create' ? (
              <TextInput
                ...
                accessibilityLabel="Confirm six-digit device PIN"
              />
            ) : null}
            ...
            >
              ...
              <Text style={styles.loginButtonText}>{isSubmitting ? 'Securing access…' : credentialMode === 'create' ? 'Create Secure Access' : 'Unlock Easy Seas'}</Text>
            </TouchableOpacity>
          ...
          >
            <Text style={styles.aboutButtonText}>About, legal &amp; responsible play</Text>
          </TouchableOpacity>
...
const styles = StyleSheet.create({
  ...
  heroImageContainer: {
    width: Math.min(width * 0.64, 340),
    aspectRatio: 1138 / 756,
    borderRadius: EASY_SEAS_UX.radius.card,
    overflow: 'hidden',
    backgroundColor: EASY_SEAS_UX.color.brandNavy,
    borderWidth: 1,
    borderColor: EASY_SEAS_UX.color.border,
    marginBottom: SPACING.md,
    shadowColor: EASY_SEAS_UX.color.brandNavy,
  ...
  card: {
    backgroundColor: EASY_SEAS_UX.color.ivory,
    borderRadius: EASY_SEAS_UX.radius.card,
    borderWidth: 1,
    borderColor: EASY_SEAS_UX.color.border,
    padding: SPACING.lg,
  ...
  accessEyebrow: { ...EASY_SEAS_TYPE_STYLES.badge, color: EASY_SEAS_UX.color.oceanTeal, letterSpacing: 1.1, marginBottom: 3 },
  accessTitle: { ...EASY_SEAS_TYPE_STYLES.sectionTitle, color: EASY_SEAS_UX.color.brandNavy },
  accessSummary: { ...EASY_SEAS_TYPE_STYLES.caption, color: EASY_SEAS_UX.color.textMuted, marginTop: 3, marginBottom: SPACING.md },
  description: {
  ...
  input: {
    minHeight: EASY_SEAS_UX.minimumTarget,
    backgroundColor: EASY_SEAS_UX.color.surface,
    borderRadius: EASY_SEAS_UX.radius.control,
  ...
  biometricButton: {
    ...
    borderRadius: EASY_SEAS_UX.radius.control,
    borderWidth: 1,
    borderColor: EASY_SEAS_UX.color.oceanTeal,
    paddingVertical: SPACING.sm,
    paddingHorizontal: SPACING.md,
    alignItems: 'center',
    marginTop: SPACING.sm,
    backgroundColor: EASY_SEAS_UX.color.seafoam,
  },
  biometricButtonText: {
    color: EASY_SEAS_UX.color.brandNavy,
    fontSize: TYPOGRAPHY.fontSizeSM,
    fontWeight: TYPOGRAPHY.fontWeightBold as any,
    textAlign: 'center',
  },
