...
export const CasinoOfferCard = React.memo(function CasinoOfferCard({ offerCode, offerName, expiryDate, tradeInValue, freePlay, obc, cruises, onPress, onCruisePress, bookedCruiseIds = new Set(), isActive = true, isBestValue = false, }: CasinoOfferCardProps) {
