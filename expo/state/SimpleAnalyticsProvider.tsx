...
export const [SimpleAnalyticsProvider, useSimpleAnalytics] = createContextHook((): SimpleAnalyticsState => {
  ...
  const casinoAnalytics = useMemo((): CasinoAnalytics => {
    ...
    const economicsSummary = buildCruiseEconomicsSummary(bookedCruises, new Date(), { scope: 'completedOnly' });
    ...
    const historicalPointsEarned = hasEconomicsRows
      ? economicsSummary.totals.totalPoints
      : (clubRoyaleHistoricalPoints > 0 ? clubRoyaleHistoricalPoints : cruisePointsSum);
