...
const PORT_COORDINATES: Record<string, { latitude: number; longitude: number; label: string }> = {
  ...
  basseterre: { latitude: 17.3026, longitude: -62.7177, label: 'Basseterre, St. Kitts' },
  'st kitts': { latitude: 17.3026, longitude: -62.7177, label: 'Basseterre, St. Kitts' },
  'st. kitts': { latitude: 17.3026, longitude: -62.7177, label: 'Basseterre, St. Kitts' },
  'st kitts nevis': { latitude: 17.3026, longitude: -62.7177, label: 'Basseterre, St. Kitts' },
  'port zante': { latitude: 17.3026, longitude: -62.7177, label: 'Basseterre, St. Kitts' },
