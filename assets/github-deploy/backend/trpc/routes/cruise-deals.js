...
const searchICruise = async (shipName, sailDate, nights, departurePort) => {
  try {
...
const fetchICruisePricing = async (shipName, sailDate, nights, departurePort) => {
  try {
    const dateObj = new Date(sailDate);
    const month = dateObj.toLocaleString('en-US', { month: 'long' });
    const year = dateObj.getFullYear();
...
const searchCruiseSheet = async (shipName, sailDate, nights, departurePort) => {
  try {
    const dateObj = new Date(sailDate);
    const month = dateObj.toLocaleString('en-US', { month: 'long' });
    const year = dateObj.getFullYear();
...
const fetchCruiseSheetPricing = async (shipName, sailDate, nights, departurePort) => {
  try {
    const dateObj = new Date(sailDate);
    const month = dateObj.toLocaleString('en-US', { month: 'long' });
    const year = dateObj.getFullYear();
