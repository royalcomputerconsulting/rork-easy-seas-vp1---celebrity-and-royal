...
export function RecognitionEntryDetailModal({ visible, entry, sailings, onClose, onUpdate, onDelete, }: RecognitionEntryDetailModalProps) {
    ...
    const handleDelete = () => {
        Alert.alert('Delete Entry', 'Are you sure you want to delete this recognition entry?', [
        ...
        <View style={styles.modal}>
          ...
          <ScrollView style={styles.content}>
            ...
            <View style={styles.section}>
              ...
              {isEditing ? (<TextInput style={styles.input} value={roleTitle} onChangeText={setRoleTitle} placeholder="Enter role title" placeholderTextColor={COLORS.textTertiary}/>) : (<Text style={styles.valueText}>{entry.roleTitle || 'N/A'}</Text>)}
            </View>

            <View style={styles.section}>
              <Text style={styles.sectionTitle}>Sailing</Text>
              {isEditing ? (<>
                  <TouchableOpacity style={styles.picker} onPress={() => setShowSailingPicker(!showSailingPicker)}>
            ...
            <View style={styles.section}>
              ...
              {isEditing ? (<TextInput style={[styles.input, styles.textArea]} value={sourceText} onChangeText={setSourceText} placeholder="Original recognition phrase" placeholderTextColor={COLORS.textTertiary} multiline numberOfLines={3}/>) : (<Text style={styles.valueText}>{entry.sourceText || 'N/A'}</Text>)}
            </View>

            {entry.crewNotes ? (<View style={styles.section}>
