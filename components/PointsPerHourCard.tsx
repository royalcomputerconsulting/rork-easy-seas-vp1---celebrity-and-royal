...
import { Zap, TrendingUp, TrendingDown, Clock, Target, Award, Activity, } from 'lucide-react-native';
...
export const PointsPerHourCard = React.memo(function PointsPerHourCard({ analytics, sessions, compact = false, }: PointsPerHourCardProps) {
    ...
    const trend = useMemo(() => {
        if (sessions.length < 2)
            return { direction: 'none' as const, change: 0 };
