...
export const TierBadge = React.memo(function TierBadge({ tier, type = 'clubRoyale', size = 'medium', onPress, showLabel = false, }: TierBadgeProps) {
    const getTierColor = () => {
        if (type === 'clubRoyale') {
...
export const TierBadgeGroup = React.memo(function TierBadgeGroup({ clubRoyaleTier, crownAnchorLevel, size = 'medium', onClubRoyalePress, onCrownAnchorPress, }: TierBadgeGroupProps) {
    return (<View style={styles.group}>
      <TierBadge tier={clubRoyaleTier} type="clubRoyale" size={size} onPress={onClubRoyalePress}/>
      <TierBadge tier={crownAnchorLevel} type="crownAnchor" size={size} onPress={onCrownAnchorPress}/>
    </View>);
});
