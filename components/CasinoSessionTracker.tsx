...
import { Dices, Clock, Target, TrendingUp, Plus, Trash2, ChevronRight, } from 'lucide-react-native';
...
function AnimatedProgressRing({ percentage, size = 120, strokeWidth = 10, goldenMinutes, playedMinutes, }: {
    percentage: number;
    size?: number;
    strokeWidth?: number;
    ...
    return (<View style={[styles.ringContainer, { width: size, height: size }]}>
...
function HourlyBreakdownChart({ goldenTimeSlots, sessions }: {
    goldenTimeSlots: GoldenTimeSlot[];
    sessions: CasinoSession[];
}) {
    ...
    return (<View style={styles.chartContainer}>
      ...
      <View style={styles.chartContent}>
        {hourlyData.map((item, index) => (<View key={index} style={styles.chartBar}>
...
export const CasinoSessionTracker = React.memo(function CasinoSessionTracker({ date, goldenTimeSlots, sessions, summary, onAddSession, onRemoveSession, onViewDetails, }: CasinoSessionTrackerProps) {
    ...
    return (<View style={styles.container}>
      <View style={styles.header}>
        ...
        <TouchableOpacity style={styles.addButton} onPress={onAddSession} activeOpacity={0.7}>
      ...
      <View style={styles.content}>
        {hasGoldenTime ? (<>
            <View style={styles.progressSection}>
              <AnimatedProgressRing percentage={summary.percentageComplete} goldenMinutes={totalGoldenMinutes} playedMinutes={summary.totalPlayedMinutes}/>
            ...
            <HourlyBreakdownChart goldenTimeSlots={goldenTimeSlots} sessions={sessions}/>
