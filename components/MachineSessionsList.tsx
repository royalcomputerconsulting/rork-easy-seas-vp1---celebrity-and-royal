...
export function MachineSessionsList({ sessions, onEditSession }: MachineSessionsListProps) {
    ...
    const renderSession = ({ item }: {
        ...
        <View style={styles.sessionHeader}>
          ...
          <TouchableOpacity style={styles.editButton} onPress={() => onEditSession(item)} activeOpacity={0.7}>
    ...
    return (<View style={styles.container}>
      ...
      <View style={styles.controls}>
        <View style={styles.filterRow}>
          ...
          <TouchableOpacity style={[styles.filterChip, filterType === 'wins' && styles.filterChipActive]} onPress={() => setFilterType('wins')} activeOpacity={0.7}>
          ...
          <TouchableOpacity style={[styles.filterChip, filterType === 'losses' && styles.filterChipActive]} onPress={() => setFilterType('losses')} activeOpacity={0.7}>
        ...
        <View style={styles.sortRow}>
          <TouchableOpacity style={styles.sortButton} onPress={() => handleSort('date')} activeOpacity={0.7}>
          ...
          <TouchableOpacity style={styles.sortButton} onPress={() => handleSort('winLoss')} activeOpacity={0.7}>
          ...
          <TouchableOpacity style={styles.sortButton} onPress={() => handleSort('machine')} activeOpacity={0.7}>
          ...
          <TouchableOpacity style={styles.sortButton} onPress={() => handleSort('duration')} activeOpacity={0.7}>
      ...
      <FlatList data={filteredAndSortedSessions} keyExtractor={(item) => item.id} renderItem={renderSession} contentContainerStyle={styles.listContent} showsVerticalScrollIndicator={false} ListEmptyComponent={<View style={styles.emptyState}>
