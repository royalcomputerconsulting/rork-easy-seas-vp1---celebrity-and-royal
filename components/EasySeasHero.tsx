...
export function EasySeasHero({ memberName = 'Player', onSettingsPress, onAlertsPress, alertCount = 0, availableCruises = 0, bookedCruises = 0, activeOffers = 0, onCruisesPress, onBookedPress, onOffersPress, }: EasySeasHeroProps) {
    const { clubRoyalePoints, clubRoyaleTier, crownAnchorPoints, crownAnchorLevel, clubRoyaleProgress, pinnacleProgress, } = useLoyalty();
    ...
    return (<View style={styles.container}>
      ...
      <View style={styles.topRow}>
        <View style={styles.brandingSection}>
          <View style={styles.logoContainer}>
            <Image source={{ uri: 'https://pub-e001eb4506b145aa938b5d3badbff6a5.r2.dev/attachments/drzllmgo03ok1wemgb3s9' }} style={styles.logoImage} resizeMode="contain"/>
          </View>
      ...
      <View style={styles.progressSection}>
        <View style={styles.progressItem}>
          ...
          <ProgressBar progress={pinnacleProgress.percentComplete} eta={`ETA: ${formatETA(pinnacleProgress.nightsToNext, 7)} • ${pinnacleProgress.nightsToNext} nights`} height={8} gradientColors={[COLORS.points, COLORS.pointsLight]}/>
        </View>
        ...
        <View style={styles.progressItem}>
          ...
          <ProgressBar progress={clubRoyaleProgress.percentComplete} eta={`ETA: ${formatETA(clubRoyaleProgress.pointsToNext, 1000)} • Resets April 1`} height={8} gradientColors={[
            clubRoyaleProgress.nextTier
