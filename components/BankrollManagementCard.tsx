...
import { DollarSign, AlertTriangle, CheckCircle, XCircle, TrendingDown, Settings, Calendar, X, } from 'lucide-react-native';
...
export function BankrollManagementCard({ compact = false, showAlerts = true, }: BankrollManagementCardProps) {
    const { alerts, getBankrollStats, checkAndTriggerAlerts, dismissAlert, clearAllAlerts, } = useBankroll();
    ...
    return (<View style={styles.container}>
      <LinearGradient colors={['#FEE2E2', '#FECACA']} style={styles.header}>
      ...
      <BankrollSettingsModal visible={showSettingsModal} onClose={() => setShowSettingsModal(false)}/>
    </View>);
}
function BankrollSettingsModal({ visible, onClose }: {
    visible: boolean;
    onClose: () => void;
}) {
        ...
        <View style={styles.modalContainer}>
          ...
          <ScrollView style={styles.modalContent} showsVerticalScrollIndicator={false}>
            <View style={styles.inputGroup}>
              ...
              <TextInput style={styles.input} value={dailyLimit} onChangeText={setDailyLimit} keyboardType="numeric" placeholder="500" placeholderTextColor="#9CA3AF"/>
            </View>

            <View style={styles.inputGroup}>
              <Text style={styles.inputLabel}>Weekly Limit ($)</Text>
              <TextInput style={styles.input} value={weeklyLimit} onChangeText={setWeeklyLimit} keyboardType="numeric" placeholder="2000" placeholderTextColor="#9CA3AF"/>
            </View>

            <View style={styles.inputGroup}>
              <Text style={styles.inputLabel}>Monthly Limit ($)</Text>
              <TextInput style={styles.input} value={monthlyLimit} onChangeText={setMonthlyLimit} keyboardType="numeric" placeholder="5000" placeholderTextColor="#9CA3AF"/>
            </View>
            ...
            <View style={styles.inputGroup}>
              ...
              <TextInput style={styles.input} value={dailyWarning} onChangeText={setDailyWarning} keyboardType="numeric" placeholder="75" placeholderTextColor="#9CA3AF"/>
            </View>

            <View style={styles.inputGroup}>
              <Text style={styles.inputLabel}>Critical Threshold (%)</Text>
              <TextInput style={styles.input} value={dailyCritical} onChangeText={setDailyCritical} keyboardType="numeric" placeholder="90" placeholderTextColor="#9CA3AF"/>
            </View>
          </ScrollView>
