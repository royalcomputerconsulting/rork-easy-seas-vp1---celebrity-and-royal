...
export function AtlasCard({ machine, onPress, isFavorite = false, onToggleFavorite, compact = false, locked = false, }: AtlasCardProps) {
    ...
    if (compact) {
        return (<TouchableOpacity style={[styles.compactContainer]} onPress={onPress} activeOpacity={0.7} testID="atlas-card-compact">
        <View style={styles.compactContent}>
          ...
          <View style={styles.compactRight}>
            {locked ? (<View style={styles.compactLockBadge} testID="atlas-card.lock">
    ...
    return (<TouchableOpacity style={styles.container} onPress={onPress} activeOpacity={0.9} testID="atlas-card">
