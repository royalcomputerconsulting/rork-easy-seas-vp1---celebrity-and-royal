...
const JACKPOT_TYPES: {
    value: 'mini' | 'minor' | 'major' | 'grand' | 'mega';
    label: string;
}[] = [
...
export default function QuickMachineWinModal({ visible, onClose, machine, onSubmit }: QuickMachineWinModalProps) {
    ...
    return (<Modal visible={visible} animationType="slide" transparent onRequestClose={onClose}>
      <View style={styles.overlay}>
        <View style={styles.modalContainer}>
          ...
          <ScrollView style={styles.scrollView} contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
            ...
            <View style={styles.section}>
              ...
              <View style={styles.denomGrid}>
                {COMMON_DENOMINATIONS.map(denom => (<TouchableOpacity key={denom} style={[
                styles.denomButton,
                selectedDenom === denom && styles.denomButtonSelected,
            ]} onPress={() => setSelectedDenom(denom)} activeOpacity={0.7}>
                    <Text style={[
            ...
            <View style={styles.section}>
              ...
              <View style={styles.amountInputContainer}>
                ...
                <TextInput style={styles.amountInput} value={winAmount} onChangeText={(text) => {
        ...
        }} keyboardType="decimal-pad" placeholder="0.00" placeholderTextColor={COLORS.textMuted} returnKeyType="done" autoFocus editable={!isSubmitting}/>
              </View>

              <View style={styles.quickAmountGrid}>
                {QUICK_AMOUNTS.map(amount => (<TouchableOpacity key={amount} style={styles.quickAmountButton} onPress={() => handleQuickAmount(amount)} activeOpacity={0.7}>
            ...
            <View style={styles.section}>
              <View style={styles.jackpotToggleRow}>
                ...
                <TouchableOpacity style={[styles.toggle, isJackpot && styles.toggleActive]} onPress={() => setIsJackpot(!isJackpot)} activeOpacity={0.7}>
            ...
            <View style={styles.section}>
              ...
              <TextInput style={styles.durationInput} value={sessionMinutes} onChangeText={setSessionMinutes} keyboardType="number-pad" placeholder="30" placeholderTextColor={COLORS.textMuted} returnKeyType="done"/>
            </View>

            <View style={styles.section}>
              <Text style={styles.sectionLabel}>Points Earned (Optional)</Text>
              <TextInput style={styles.durationInput} value={pointsEarned} onChangeText={setPointsEarned} keyboardType="number-pad" placeholder="0" placeholderTextColor={COLORS.textMuted} returnKeyType="done"/>
            </View>

            <View style={styles.section}>
              <Text style={styles.sectionLabel}>Notes (Optional)</Text>
              <TextInput style={styles.notesInput} value={notes} onChangeText={setNotes} placeholder="Add any additional details..." placeholderTextColor={COLORS.textMuted} multiline numberOfLines={3} textAlignVertical="top" returnKeyType="done"/>
            </View>
          </ScrollView>
          ...
          <View style={styles.footer}>
            ...
            <TouchableOpacity style={[styles.submitButton, !canSubmit && styles.submitButtonDisabled]} onPress={handleSubmit} disabled={!canSubmit} activeOpacity={0.7}>
